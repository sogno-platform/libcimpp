...
bool assign_ProvidedBilateralPoint_BilateralExchangeActor(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Base::ICCPConfiguration::ProvidedBilateralPoint* element = dynamic_cast<IEC61970::Base::ICCPConfiguration::ProvidedBilateralPoint*>(BaseClass_ptr1))
	{
		element->BilateralExchangeActor = dynamic_cast<IEC61970::Base::ICCPConfiguration::BilateralExchangeActor*>(BaseClass_ptr2);
		if(element->BilateralExchangeActor != nullptr)
			return true;
	}
	return false;
}
...
bool assign_ConfigurationEvent_FaultCauseType(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Common::ConfigurationEvent* element = dynamic_cast<IEC61968::Common::ConfigurationEvent*>(BaseClass_ptr1))
	{
		element->FaultCauseType = dynamic_cast<IEC61970::Base::Faults::FaultCauseType*>(BaseClass_ptr2);
		if(element->FaultCauseType != nullptr)
			return true;
	}
	return false;
}
...
bool assign_AssetInfo_CatalogAssetType(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::AssetInfo* element = dynamic_cast<IEC61968::Assets::AssetInfo*>(BaseClass_ptr1))
	{
		element->CatalogAssetType = dynamic_cast<IEC61968::Assets::CatalogAssetType*>(BaseClass_ptr2);
		if(element->CatalogAssetType != nullptr)
			return true;
	}
	return false;
}
...
bool assign_WirePhaseInfo_WireAssemblyInfo(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::AssetInfo::WirePhaseInfo* element = dynamic_cast<IEC61968::AssetInfo::WirePhaseInfo*>(BaseClass_ptr1))
	{
		element->WireAssemblyInfo = dynamic_cast<IEC61968::AssetInfo::WireAssemblyInfo*>(BaseClass_ptr2);
		if(element->WireAssemblyInfo != nullptr)
			return true;
	}
	return false;
}
...
bool assign_Organisation_ParentOrganisation(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Common::Organisation* element = dynamic_cast<IEC61968::Common::Organisation*>(BaseClass_ptr1))
	{
		element->ParentOrganisation = dynamic_cast<IEC61968::Common::ParentOrganization*>(BaseClass_ptr2);
		if(element->ParentOrganisation != nullptr)
			return true;
	}
	return false;
}
...
bool assign_AssetDeployment_BaseVoltage(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::AssetDeployment* element = dynamic_cast<IEC61968::Assets::AssetDeployment*>(BaseClass_ptr1))
	{
		element->BaseVoltage = dynamic_cast<IEC61970::Base::Core::BaseVoltage*>(BaseClass_ptr2);
		if(element->BaseVoltage != nullptr)
			return true;
...
bool assign_Fault_Location(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Base::Faults::Fault* element = dynamic_cast<IEC61970::Base::Faults::Fault*>(BaseClass_ptr1))
	{
...
bool assign_ConsumptionTariffInterval_ReadingType(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
...
bool assign_SwitchingAction_Operator(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::SwitchingAction* element = dynamic_cast<IEC61968::Operations::SwitchingAction*>(BaseClass_ptr1))
	{
...
bool assign_SwitchingPlan_OutagePlan(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::SwitchingPlan* element = dynamic_cast<IEC61968::Operations::SwitchingPlan*>(BaseClass_ptr1))
	{
		element->OutagePlan = dynamic_cast<IEC61968::Operations::OutagePlan*>(BaseClass_ptr2);
		if(element->OutagePlan != nullptr)
			return true;
	}
	return false;
}

bool assign_SwitchingOrder_SwitchingPlan(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::SwitchingOrder* element = dynamic_cast<IEC61968::Operations::SwitchingOrder*>(BaseClass_ptr1))
	{
		element->SwitchingPlan = dynamic_cast<IEC61968::Operations::SwitchingPlan*>(BaseClass_ptr2);
		if(element->SwitchingPlan != nullptr)
			return true;
	}
	return false;
}
...
bool assign_Location_SwitchingOrder(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Common::Location* element = dynamic_cast<IEC61968::Common::Location*>(BaseClass_ptr1))
	{
		element->SwitchingOrder = dynamic_cast<IEC61968::Operations::SwitchingOrder*>(BaseClass_ptr2);
		if(element->SwitchingOrder != nullptr)
			return true;
	}
	return false;
}
...
bool assign_CatalogAssetType_TypeAssetCatalogue(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::CatalogAssetType* element = dynamic_cast<IEC61968::Assets::CatalogAssetType*>(BaseClass_ptr1))
	{
...
bool assign_ProductAssetModel_AssetInfo(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
...
bool assign_ProductAssetModel_CatalogAssetType(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::ProductAssetModel* element = dynamic_cast<IEC61968::Assets::ProductAssetModel*>(BaseClass_ptr1))
	{
		element->CatalogAssetType = dynamic_cast<IEC61968::Assets::CatalogAssetType*>(BaseClass_ptr2);
...
bool assign_Asset_AssetDeployment(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::Asset* element = dynamic_cast<IEC61968::Assets::Asset*>(BaseClass_ptr1))
	{
		element->AssetDeployment = dynamic_cast<IEC61968::Assets::AssetDeployment*>(BaseClass_ptr2);
		if(element->AssetDeployment != nullptr)
			return true;
	}
	return false;
}
...
bool assign_Asset_ProductAssetModel(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::Asset* element = dynamic_cast<IEC61968::Assets::Asset*>(BaseClass_ptr1))
	{
...
bool assign_WireSpacing_DuctBank(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::AssetInfo::WireSpacing* element = dynamic_cast<IEC61968::AssetInfo::WireSpacing*>(BaseClass_ptr1))
	{
		element->DuctBank = dynamic_cast<IEC61968::Assets::DuctBank*>(BaseClass_ptr2);
...
bool assign_EndDeviceGroup_DispatchablePowerCapability(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Metering::EndDeviceGroup* element = dynamic_cast<IEC61968::Metering::EndDeviceGroup*>(BaseClass_ptr1))
	{
		element->DispatchablePowerCapability = dynamic_cast<IEC61968::DER::DispatchablePowerCapability*>(BaseClass_ptr2);
		if(element->DispatchablePowerCapability != nullptr)
			return true;
	}
	return false;
}

bool assign_DispatchSchedule_DERMonitorableParameter(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::DER::DispatchSchedule* element = dynamic_cast<IEC61968::DER::DispatchSchedule*>(BaseClass_ptr1))
	{
		element->DERMonitorableParameter = dynamic_cast<IEC61968::DER::DERMonitorableParameter*>(BaseClass_ptr2);
		if(element->DERMonitorableParameter != nullptr)
			return true;
	}
	return false;
}

bool assign_DERCurveData_DispatchSchedule(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::DER::DERCurveData* element = dynamic_cast<IEC61968::DER::DERCurveData*>(BaseClass_ptr1))
	{
		element->DispatchSchedule = dynamic_cast<IEC61968::DER::DispatchSchedule*>(BaseClass_ptr2);
		if(element->DispatchSchedule != nullptr)
			return true;
	}
	return false;
}

bool assign_DERCurveData_DERMonitorableParameter(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::DER::DERCurveData* element = dynamic_cast<IEC61968::DER::DERCurveData*>(BaseClass_ptr1))
	{
		element->DERMonitorableParameter = dynamic_cast<IEC61968::DER::DERMonitorableParameter*>(BaseClass_ptr2);
...
bool assign_Incident_Location(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::Incident* element = dynamic_cast<IEC61968::Operations::Incident*>(BaseClass_ptr1))
	{
		element->Location = dynamic_cast<IEC61968::Common::Location*>(BaseClass_ptr2);
...
bool assign_MeterWorkTask_UsagePoint(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Metering::MeterWorkTask* element = dynamic_cast<IEC61968::Metering::MeterWorkTask*>(BaseClass_ptr1))
	{
		element->UsagePoint = dynamic_cast<IEC61968::Metering::UsagePoint*>(BaseClass_ptr2);
		if(element->UsagePoint != nullptr)
			return true;
...
bool assign_MeterWorkTask_Meter(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Metering::MeterWorkTask* element = dynamic_cast<IEC61968::Metering::MeterWorkTask*>(BaseClass_ptr1))
	{
		element->Meter = dynamic_cast<IEC61968::Metering::Meter*>(BaseClass_ptr2);
...
bool assign_MeterWorkTask_OldMeter(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Metering::MeterWorkTask* element = dynamic_cast<IEC61968::Metering::MeterWorkTask*>(BaseClass_ptr1))
	{
...
bool assign_ProcedureDataSet_Asset(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
...
bool assign_ProcedureDataSet_WorkTask(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::ProcedureDataSet* element = dynamic_cast<IEC61968::Assets::ProcedureDataSet*>(BaseClass_ptr1))
	{
		element->WorkTask = dynamic_cast<IEC61968::Work::WorkTask*>(BaseClass_ptr2);
		if(element->WorkTask != nullptr)
			return true;
	}
	return false;
...
bool assign_OutagePlan_OutageOrder(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::OutagePlan* element = dynamic_cast<IEC61968::Operations::OutagePlan*>(BaseClass_ptr1))
	{
		element->OutageOrder = dynamic_cast<IEC61968::Operations::OutageOrder*>(BaseClass_ptr2);
		if(element->OutageOrder != nullptr)
			return true;
	}
	return false;
}

bool assign_OutagePlan_PlannedOutage(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::OutagePlan* element = dynamic_cast<IEC61968::Operations::OutagePlan*>(BaseClass_ptr1))
	{
		element->PlannedOutage = dynamic_cast<IEC61968::Operations::PlannedOutage*>(BaseClass_ptr2);
...
bool assign_Customer_OutagePlan(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
...
bool assign_AnalyticScore_Asset(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::AnalyticScore* element = dynamic_cast<IEC61968::Assets::AnalyticScore*>(BaseClass_ptr1))
	{
		element->Asset = dynamic_cast<IEC61968::Assets::Asset*>(BaseClass_ptr2);
		if(element->Asset != nullptr)
			return true;
...
{
	if(IEC61968::Assets::Bushing* element = dynamic_cast<IEC61968::Assets::Bushing*>(BaseClass_ptr1))
	{
		element->Terminal = dynamic_cast<IEC61970::Base::Core::Terminal*>(BaseClass_ptr2);
		if(element->Terminal != nullptr)
			return true;
...
bool assign_Specimen_AssetTestSampleTaker(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::Specimen* element = dynamic_cast<IEC61968::Assets::Specimen*>(BaseClass_ptr1))
	{
		element->AssetTestSampleTaker = dynamic_cast<IEC61968::Assets::AssetTestSampleTaker*>(BaseClass_ptr2);
		if(element->AssetTestSampleTaker != nullptr)
			return true;
	}
	return false;
}

bool assign_LabTestDataSet_Specimen(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::LabTestDataSet* element = dynamic_cast<IEC61968::Assets::LabTestDataSet*>(BaseClass_ptr1))
	{
		element->Specimen = dynamic_cast<IEC61968::Assets::Specimen*>(BaseClass_ptr2);
		if(element->Specimen != nullptr)
			return true;
	}
	return false;
}

bool assign_LabTestDataSet_AssetTestLab(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::LabTestDataSet* element = dynamic_cast<IEC61968::Assets::LabTestDataSet*>(BaseClass_ptr1))
	{
		element->AssetTestLab = dynamic_cast<IEC61968::Assets::AssetTestLab*>(BaseClass_ptr2);
		if(element->AssetTestLab != nullptr)
			return true;
	}
	return false;
}

bool assign_HealthScore_AssetRiskScore(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::HealthScore* element = dynamic_cast<IEC61968::Assets::HealthScore*>(BaseClass_ptr1))
	{
		element->AssetRiskScore = dynamic_cast<IEC61968::Assets::RiskScore*>(BaseClass_ptr2);
		if(element->AssetRiskScore != nullptr)
			return true;
	}
	return false;
}
...
{
	if(IEC61968::Assets::FinancialInfo* element = dynamic_cast<IEC61968::Assets::FinancialInfo*>(BaseClass_ptr1))
	{
		element->Asset = dynamic_cast<IEC61968::Assets::Asset*>(BaseClass_ptr2);
		if(element->Asset != nullptr)
			return true;
...
bool assign_SwitchOperationSummary_Breaker(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::SwitchOperationSummary* element = dynamic_cast<IEC61968::Assets::SwitchOperationSummary*>(BaseClass_ptr1))
	{
		element->Breaker = dynamic_cast<IEC61968::Assets::Asset*>(BaseClass_ptr2);
		if(element->Breaker != nullptr)
			return true;
	}
	return false;
}
...
bool assign_ScheduledEventData_InspectionDataSet(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	...
	{
		element->InspectionDataSet = dynamic_cast<IEC61968::Assets::InspectionDataSet*>(BaseClass_ptr2);
...
bool assign_FieldDispatchHistory_UnplannedOutage(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Common::FieldDispatchHistory* element = dynamic_cast<IEC61968::Common::FieldDispatchHistory*>(BaseClass_ptr1))
	{
		element->UnplannedOutage = dynamic_cast<IEC61968::Operations::UnplannedOutage*>(BaseClass_ptr2);
		if(element->UnplannedOutage != nullptr)
			return true;
	}
	return false;
}

bool assign_FieldDispatchHistory_PlannedOutage(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Common::FieldDispatchHistory* element = dynamic_cast<IEC61968::Common::FieldDispatchHistory*>(BaseClass_ptr1))
	{
		element->PlannedOutage = dynamic_cast<IEC61968::Operations::PlannedOutage*>(BaseClass_ptr2);
...
bool assign_FieldDispatchHistory_Crew(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Common::FieldDispatchHistory* element = dynamic_cast<IEC61968::Common::FieldDispatchHistory*>(BaseClass_ptr1))
	{
		element->Crew = dynamic_cast<IEC61968::Common::Crew*>(BaseClass_ptr2);
...
bool assign_TroubleOrder_Incident(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::TroubleOrder* element = dynamic_cast<IEC61968::Operations::TroubleOrder*>(BaseClass_ptr1))
	{
		element->Incident = dynamic_cast<IEC61968::Operations::Incident*>(BaseClass_ptr2);
		if(element->Incident != nullptr)
			return true;
...
bool assign_TroubleOrder_Location(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::TroubleOrder* element = dynamic_cast<IEC61968::Operations::TroubleOrder*>(BaseClass_ptr1))
	{
		element->Location = dynamic_cast<IEC61968::Common::Location*>(BaseClass_ptr2);
...
bool assign_OperationalTag_PowerSystemResource(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::OperationalTag* element = dynamic_cast<IEC61968::Operations::OperationalTag*>(BaseClass_ptr1))
	{
		element->PowerSystemResource = dynamic_cast<IEC61970::Base::Core::PowerSystemResource*>(BaseClass_ptr2);
		if(element->PowerSystemResource != nullptr)
			return true;
...
bool assign_OperationalTag_Asset(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::OperationalTag* element = dynamic_cast<IEC61968::Operations::OperationalTag*>(BaseClass_ptr1))
	{
		element->Asset = dynamic_cast<IEC61968::Assets::Asset*>(BaseClass_ptr2);
...
bool assign_MeasurementAction_Measurement(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::MeasurementAction* element = dynamic_cast<IEC61968::Operations::MeasurementAction*>(BaseClass_ptr1))
	{
		element->Measurement = dynamic_cast<IEC61970::Base::Meas::Measurement*>(BaseClass_ptr2);
		if(element->Measurement != nullptr)
			return true;
	}
	return false;
}

bool assign_GenericAction_PowerSystemResource(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::GenericAction* element = dynamic_cast<IEC61968::Operations::GenericAction*>(BaseClass_ptr1))
	{
		element->PowerSystemResource = dynamic_cast<IEC61970::Base::Core::PowerSystemResource*>(BaseClass_ptr2);
		if(element->PowerSystemResource != nullptr)
			return true;
...
bool assign_VerificationAction_PowerSystemResource(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::VerificationAction* element = dynamic_cast<IEC61968::Operations::VerificationAction*>(BaseClass_ptr1))
	{
		element->PowerSystemResource = dynamic_cast<IEC61970::Base::Core::PowerSystemResource*>(BaseClass_ptr2);
		if(element->PowerSystemResource != nullptr)
			return true;
...
bool assign_TagAction_OperationalTag(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::TagAction* element = dynamic_cast<IEC61968::Operations::TagAction*>(BaseClass_ptr1))
	{
		element->OperationalTag = dynamic_cast<IEC61968::Operations::OperationalTag*>(BaseClass_ptr2);
		if(element->OperationalTag != nullptr)
			return true;
	}
	return false;
}

bool assign_SwitchingStep_SwitchingStepGroup(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::SwitchingStep* element = dynamic_cast<IEC61968::Operations::SwitchingStep*>(BaseClass_ptr1))
	{
		element->SwitchingStepGroup = dynamic_cast<IEC61968::Operations::SwitchingStepGroup*>(BaseClass_ptr2);
		if(element->SwitchingStepGroup != nullptr)
			return true;
	}
	return false;
}

bool assign_SwitchingStep_SwitchingAction(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::SwitchingStep* element = dynamic_cast<IEC61968::Operations::SwitchingStep*>(BaseClass_ptr1))
	{
		element->SwitchingAction = dynamic_cast<IEC61968::Operations::SwitchingAction*>(BaseClass_ptr2);
		if(element->SwitchingAction != nullptr)
			return true;
	}
	return false;
}

bool assign_ControlAction_Control(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::ControlAction* element = dynamic_cast<IEC61968::Operations::ControlAction*>(BaseClass_ptr1))
	{
...
bool assign_CompatibleUnit_GenericAssetModel(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::InfIEC61968::InfWork::CompatibleUnit* element = dynamic_cast<IEC61968::InfIEC61968::InfWork::CompatibleUnit*>(BaseClass_ptr1))
	{
		element->GenericAssetModel = dynamic_cast<IEC61968::Assets::CatalogAssetType*>(BaseClass_ptr2);
		if(element->GenericAssetModel != nullptr)
			return true;
	}
	return false;
}
...
bool assign_CUWorkEquipmentItem_TypeAsset(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	...
	{
		element->TypeAsset = dynamic_cast<IEC61968::Work::WorkAsset*>(BaseClass_ptr2);
...
bool assign_ErpLedgerEntry_ErpLedBudLineItem(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::InfIEC61968::InfERPSupport::ErpLedgerEntry* element = dynamic_cast<IEC61968::InfIEC61968::InfERPSupport::ErpLedgerEntry*>(BaseClass_ptr1))
	{
		element->ErpLedBudLineItem = dynamic_cast<IEC61968::InfIEC61968::InfERPSupport::ErpLedBudLineItem*>(BaseClass_ptr2);
		if(element->ErpLedBudLineItem != nullptr)
			return true;
	}
	return false;
}
...
bool assign_ErpIssueInventory_TypeAsset(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::InfIEC61968::InfERPSupport::ErpIssueInventory* element = dynamic_cast<IEC61968::InfIEC61968::InfERPSupport::ErpIssueInventory*>(BaseClass_ptr1))
	{
		element->TypeAsset = dynamic_cast<IEC61968::Assets::CatalogAssetType*>(BaseClass_ptr2);
		if(element->TypeAsset != nullptr)
			return true;
	}
	return false;
...
bool assign_AssetDiscrete_TestStandard(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::AssetMeas::AssetDiscrete* element = dynamic_cast<IEC61968::AssetMeas::AssetDiscrete*>(BaseClass_ptr1))
	{
		element->TestStandard = dynamic_cast<IEC61968::Assets::TestStandard*>(BaseClass_ptr2);
		if(element->TestStandard != nullptr)
			return true;
	}
	return false;
}
...
bool assign_AssetAnalog_TestStandard(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::AssetMeas::AssetAnalog* element = dynamic_cast<IEC61968::AssetMeas::AssetAnalog*>(BaseClass_ptr1))
	{
		element->TestStandard = dynamic_cast<IEC61968::Assets::TestStandard*>(BaseClass_ptr2);
		if(element->TestStandard != nullptr)
			return true;
...
bool assign_CalculationMethodHierarchy_MeasurementValue(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::AssetMeas::CalculationMethodHierarchy* element = dynamic_cast<IEC61968::AssetMeas::CalculationMethodHierarchy*>(BaseClass_ptr1))
	{
		element->MeasurementValue = dynamic_cast<IEC61970::Base::Meas::MeasurementValue*>(BaseClass_ptr2);
...
bool assign_CalculationMethodOrder_CalculationMethodHierarchy(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::AssetMeas::CalculationMethodOrder* element = dynamic_cast<IEC61968::AssetMeas::CalculationMethodOrder*>(BaseClass_ptr1))
	{
		element->CalculationMethodHierarchy = dynamic_cast<IEC61968::AssetMeas::CalculationMethodHierarchy*>(BaseClass_ptr2);
		if(element->CalculationMethodHierarchy != nullptr)
			return true;
	}
	return false;
}

bool assign_AssetStringMeasurement_TestStandard(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::AssetMeas::AssetStringMeasurement* element = dynamic_cast<IEC61968::AssetMeas::AssetStringMeasurement*>(BaseClass_ptr1))
	{
		element->TestStandard = dynamic_cast<IEC61968::Assets::TestStandard*>(BaseClass_ptr2);
		if(element->TestStandard != nullptr)
			return true;
...
bool assign_BusNameMarker_TopologicalNode(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Base::Topology::BusNameMarker* element = dynamic_cast<IEC61970::Base::Topology::BusNameMarker*>(BaseClass_ptr1))
	{
...
bool assign_DCBaseTerminal_DCTopologicalNode(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	...
	{
		element->DCTopologicalNode = dynamic_cast<IEC61970::Base::DC::DCTopologicalNode*>(BaseClass_ptr2);
...
bool assign_CommunicationLink_BilateralExchangeActor(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
...
bool assign_BilateralExchangeAgreement_Provider(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Base::ICCPConfiguration::BilateralExchangeAgreement* element = dynamic_cast<IEC61970::Base::ICCPConfiguration::BilateralExchangeAgreement*>(BaseClass_ptr1))
	{
		element->Provider = dynamic_cast<IEC61970::Base::ICCPConfiguration::BilateralExchangeActor*>(BaseClass_ptr2);
		if(element->Provider != nullptr)
			return true;
	}
	return false;
}

bool assign_BilateralExchangeAgreement_Consumer(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Base::ICCPConfiguration::BilateralExchangeAgreement* element = dynamic_cast<IEC61970::Base::ICCPConfiguration::BilateralExchangeAgreement*>(BaseClass_ptr1))
	{
		element->Consumer = dynamic_cast<IEC61970::Base::ICCPConfiguration::BilateralExchangeActor*>(BaseClass_ptr2);
		if(element->Consumer != nullptr)
			return true;
	}
	return false;
}

bool assign_PublicX509Certificate_TCPAccessPoint(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Base::ICCPConfiguration::PublicX509Certificate* element = dynamic_cast<IEC61970::Base::ICCPConfiguration::PublicX509Certificate*>(BaseClass_ptr1))
	{
		element->TCPAccessPoint = dynamic_cast<IEC61970::Base::ICCPConfiguration::TCPAccessPoint*>(BaseClass_ptr2);
		if(element->TCPAccessPoint != nullptr)
			return true;
	}
	return false;
}

bool assign_PublicX509Certificate_ISOUpperLayer(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Base::ICCPConfiguration::PublicX509Certificate* element = dynamic_cast<IEC61970::Base::ICCPConfiguration::PublicX509Certificate*>(BaseClass_ptr1))
	{
		element->ISOUpperLayer = dynamic_cast<IEC61970::Base::ICCPConfiguration::ISOUpperLayer*>(BaseClass_ptr2);
		if(element->ISOUpperLayer != nullptr)
			return true;
	}
	return false;
}
...
bool assign_DifferenceModel_reverseDifferences(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Part552Header::DifferenceModel::DifferenceModel* element = dynamic_cast<IEC61970::Part552Header::DifferenceModel::DifferenceModel*>(BaseClass_ptr1))
	{
		element->reverseDifferences = dynamic_cast<IEC61970::Part552Header::Statements*>(BaseClass_ptr2);
		if(element->reverseDifferences != nullptr)
			return true;
	}
	return false;
}

bool assign_DifferenceModel_forwardDifferences(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Part552Header::DifferenceModel::DifferenceModel* element = dynamic_cast<IEC61970::Part552Header::DifferenceModel::DifferenceModel*>(BaseClass_ptr1))
	{
		element->forwardDifferences = dynamic_cast<IEC61970::Part552Header::Statements*>(BaseClass_ptr2);
		if(element->forwardDifferences != nullptr)
			return true;
	}
	return false;
}

bool assign_DataSetMember_PropertiesObject(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Part303::GenericDataset::DataSetMember* element = dynamic_cast<IEC61970::Part303::GenericDataset::DataSetMember*>(BaseClass_ptr1))
	{
		element->PropertiesObject = dynamic_cast<IEC61970::Base::Core::IdentifiedObject*>(BaseClass_ptr2);
		if(element->PropertiesObject != nullptr)
			return true;
	}
	return false;
}

bool assign_DataSetMember_TargetObject(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Part303::GenericDataset::DataSetMember* element = dynamic_cast<IEC61970::Part303::GenericDataset::DataSetMember*>(BaseClass_ptr1))
	{
		element->TargetObject = dynamic_cast<IEC61970::Base::Core::IdentifiedObject*>(BaseClass_ptr2);
		if(element->TargetObject != nullptr)
			return true;
	}
	return false;
}

bool assign_ChangeSetMember_Changeset(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Part303::GenericDataset::ChangeSetMember* element = dynamic_cast<IEC61970::Part303::GenericDataset::ChangeSetMember*>(BaseClass_ptr1))
	{
		element->Changeset = dynamic_cast<IEC61970::Part303::GenericDataset::ChangeSet*>(BaseClass_ptr2);
		if(element->Changeset != nullptr)
			return true;
	}
	return false;
}

bool assign_ObjectReverseModification_ObjectModification(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Part303::GenericDataset::ObjectReverseModification* element = dynamic_cast<IEC61970::Part303::GenericDataset::ObjectReverseModification*>(BaseClass_ptr1))
	{
		element->ObjectModification = dynamic_cast<IEC61970::Part303::GenericDataset::ObjectModification*>(BaseClass_ptr2);
		if(element->ObjectModification != nullptr)
			return true;
	}
	return false;
}

bool assign_InstanceSetMember_InstanceSet(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Part303::GenericDataset::InstanceSetMember* element = dynamic_cast<IEC61970::Part303::GenericDataset::InstanceSetMember*>(BaseClass_ptr1))
	{
		element->InstanceSet = dynamic_cast<IEC61970::Part303::GenericDataset::InstanceSet*>(BaseClass_ptr2);
		if(element->InstanceSet != nullptr)
			return true;
	}
	return false;
}
...
bool assign_WindTurbineType3or4Dynamics_PowerElectronicsConnection(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Dynamics::StandardModels::WindDynamics::WindTurbineType3or4Dynamics* element = dynamic_cast<IEC61970::Dynamics::StandardModels::WindDynamics::WindTurbineType3or4Dynamics*>(BaseClass_ptr1))
	{
		element->PowerElectronicsConnection = dynamic_cast<IEC61970::Base::Wires::PowerElectronicsConnection*>(BaseClass_ptr2);
		if(element->PowerElectronicsConnection != nullptr)
			return true;
	}
	return false;
}
...
bool assign_BilateralExchangeActor_ProviderBilateralExchange(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Base::ICCPConfiguration::BilateralExchangeActor* element = dynamic_cast<IEC61970::Base::ICCPConfiguration::BilateralExchangeActor*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61970::Base::ICCPConfiguration::BilateralExchangeAgreement*>(BaseClass_ptr2) != nullptr)
		{
			element->ProviderBilateralExchange.push_back(dynamic_cast<IEC61970::Base::ICCPConfiguration::BilateralExchangeAgreement*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_IOPoint_BilateralToIOPoint(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Base::Meas::IOPoint* element = dynamic_cast<IEC61970::Base::Meas::IOPoint*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61970::Base::ICCPConfiguration::ProvidedBilateralPoint*>(BaseClass_ptr2) != nullptr)
		{
			element->BilateralToIOPoint.push_back(dynamic_cast<IEC61970::Base::ICCPConfiguration::ProvidedBilateralPoint*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_PowerSystemResource_ConfigurationEvent(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Base::Core::PowerSystemResource* element = dynamic_cast<IEC61970::Base::Core::PowerSystemResource*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Common::ConfigurationEvent*>(BaseClass_ptr2) != nullptr)
		{
			element->ConfigurationEvent.push_back(dynamic_cast<IEC61968::Common::ConfigurationEvent*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_WireAssemblyInfo_PerLengthLineParameter(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::AssetInfo::WireAssemblyInfo* element = dynamic_cast<IEC61968::AssetInfo::WireAssemblyInfo*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61970::Base::Wires::PerLengthLineParameter*>(BaseClass_ptr2) != nullptr)
		{
			element->PerLengthLineParameter.push_back(dynamic_cast<IEC61970::Base::Wires::PerLengthLineParameter*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_WireInfo_WirePhaseInfo(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::AssetInfo::WireInfo* element = dynamic_cast<IEC61968::AssetInfo::WireInfo*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::AssetInfo::WirePhaseInfo*>(BaseClass_ptr2) != nullptr)
		{
			element->WirePhaseInfo.push_back(dynamic_cast<IEC61968::AssetInfo::WirePhaseInfo*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_WirePosition_WirePhaseInfo(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::AssetInfo::WirePosition* element = dynamic_cast<IEC61968::AssetInfo::WirePosition*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::AssetInfo::WirePhaseInfo*>(BaseClass_ptr2) != nullptr)
		{
			element->WirePhaseInfo.push_back(dynamic_cast<IEC61968::AssetInfo::WirePhaseInfo*>(BaseClass_ptr2));
...
bool assign_SwitchingAction_Crew(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::SwitchingAction* element = dynamic_cast<IEC61968::Operations::SwitchingAction*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Common::Crew*>(BaseClass_ptr2) != nullptr)
		{
			element->Crew.push_back(dynamic_cast<IEC61968::Common::Crew*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_Outage_DeEnergizedUsagePoint(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::Outage* element = dynamic_cast<IEC61968::Operations::Outage*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Metering::UsagePoint*>(BaseClass_ptr2) != nullptr)
		{
			element->DeEnergizedUsagePoint.push_back(dynamic_cast<IEC61968::Metering::UsagePoint*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_Outage_EnergizedUsagePoint(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::Outage* element = dynamic_cast<IEC61968::Operations::Outage*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Metering::UsagePoint*>(BaseClass_ptr2) != nullptr)
		{
			element->EnergizedUsagePoint.push_back(dynamic_cast<IEC61968::Metering::UsagePoint*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_Outage_Crew(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::Outage* element = dynamic_cast<IEC61968::Operations::Outage*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Common::Crew*>(BaseClass_ptr2) != nullptr)
...
bool assign_Location_Crew(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Common::Location* element = dynamic_cast<IEC61968::Common::Location*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Common::Crew*>(BaseClass_ptr2) != nullptr)
...
bool assign_BaseWork_WorkActivityRecords(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Work::BaseWork* element = dynamic_cast<IEC61968::Work::BaseWork*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Work::WorkActivityRecord*>(BaseClass_ptr2) != nullptr)
		{
			element->WorkActivityRecords.push_back(dynamic_cast<IEC61968::Work::WorkActivityRecord*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_Medium_Asset(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::Medium* element = dynamic_cast<IEC61968::Assets::Medium*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Assets::Asset*>(BaseClass_ptr2) != nullptr)
		{
			element->Asset.push_back(dynamic_cast<IEC61968::Assets::Asset*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_Specification_Mediums(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::InfIEC61968::InfAssets::Specification* element = dynamic_cast<IEC61968::InfIEC61968::InfAssets::Specification*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Assets::Medium*>(BaseClass_ptr2) != nullptr)
		{
			element->Mediums.push_back(dynamic_cast<IEC61968::Assets::Medium*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_CatalogAssetType_ErpReqLineItems(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::CatalogAssetType* element = dynamic_cast<IEC61968::Assets::CatalogAssetType*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::InfIEC61968::InfERPSupport::ErpReqLineItem*>(BaseClass_ptr2) != nullptr)
...
bool assign_CatalogAssetType_ErpBomItemDatas(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::CatalogAssetType* element = dynamic_cast<IEC61968::Assets::CatalogAssetType*>(BaseClass_ptr1))
	{
...
bool assign_Asset_AssetFunction(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::Asset* element = dynamic_cast<IEC61968::Assets::Asset*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Assets::AssetFunction*>(BaseClass_ptr2) != nullptr)
		{
			element->AssetFunction.push_back(dynamic_cast<IEC61968::Assets::AssetFunction*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
{
	if(IEC61968::Assets::Structure* element = dynamic_cast<IEC61968::Assets::Structure*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Assets::StructureSupport*>(BaseClass_ptr2) != nullptr)
		{
			element->StructureSupports.push_back(dynamic_cast<IEC61968::Assets::StructureSupport*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_WireSpacing_WirePositions(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::AssetInfo::WireSpacing* element = dynamic_cast<IEC61968::AssetInfo::WireSpacing*>(BaseClass_ptr1))
	{
...
bool assign_WireSpacing_Structures(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::AssetInfo::WireSpacing* element = dynamic_cast<IEC61968::AssetInfo::WireSpacing*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Assets::Structure*>(BaseClass_ptr2) != nullptr)
		{
			element->Structures.push_back(dynamic_cast<IEC61968::Assets::Structure*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_RepairItem_RepairWorkTask(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Work::RepairItem* element = dynamic_cast<IEC61968::Work::RepairItem*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Work::RepairWorkTask*>(BaseClass_ptr2) != nullptr)
		{
			element->RepairWorkTask.push_back(dynamic_cast<IEC61968::Work::RepairWorkTask*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_EndDevice_DispatchablePowerCapability(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Metering::EndDevice* element = dynamic_cast<IEC61968::Metering::EndDevice*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::DER::DispatchablePowerCapability*>(BaseClass_ptr2) != nullptr)
		{
			element->DispatchablePowerCapability.push_back(dynamic_cast<IEC61968::DER::DispatchablePowerCapability*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_EndDeviceGroup_DERGroupDispatch(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Metering::EndDeviceGroup* element = dynamic_cast<IEC61968::Metering::EndDeviceGroup*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::DER::DERGroupDispatch*>(BaseClass_ptr2) != nullptr)
		{
			element->DERGroupDispatch.push_back(dynamic_cast<IEC61968::DER::DERGroupDispatch*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_EndDeviceGroup_DERMonitorableParameter(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Metering::EndDeviceGroup* element = dynamic_cast<IEC61968::Metering::EndDeviceGroup*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::DER::DERMonitorableParameter*>(BaseClass_ptr2) != nullptr)
		{
			element->DERMonitorableParameter.push_back(dynamic_cast<IEC61968::DER::DERMonitorableParameter*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_DERGroupForecast_EndDeviceGroup(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::DER::DERGroupForecast* element = dynamic_cast<IEC61968::DER::DERGroupForecast*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Metering::EndDeviceGroup*>(BaseClass_ptr2) != nullptr)
		{
			element->EndDeviceGroup.push_back(dynamic_cast<IEC61968::Metering::EndDeviceGroup*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_DERFunction_EndDeviceGroup(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::DER::DERFunction* element = dynamic_cast<IEC61968::DER::DERFunction*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Metering::EndDeviceGroup*>(BaseClass_ptr2) != nullptr)
		{
			element->EndDeviceGroup.push_back(dynamic_cast<IEC61968::Metering::EndDeviceGroup*>(BaseClass_ptr2));
...
bool assign_Incident_IncidentHazard(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::Incident* element = dynamic_cast<IEC61968::Operations::Incident*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Customers::IncidentHazard*>(BaseClass_ptr2) != nullptr)
		{
			element->IncidentHazard.push_back(dynamic_cast<IEC61968::Customers::IncidentHazard*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_TroubleTicket_IncidentHazard(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Customers::TroubleTicket* element = dynamic_cast<IEC61968::Customers::TroubleTicket*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Customers::IncidentHazard*>(BaseClass_ptr2) != nullptr)
...
bool assign_ServiceLocation_TroubleTicket(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Customers::ServiceLocation* element = dynamic_cast<IEC61968::Customers::ServiceLocation*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Customers::TroubleTicket*>(BaseClass_ptr2) != nullptr)
		{
			element->TroubleTicket.push_back(dynamic_cast<IEC61968::Customers::TroubleTicket*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_ProcedureDataSet_MeasurementValue(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::ProcedureDataSet* element = dynamic_cast<IEC61968::Assets::ProcedureDataSet*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61970::Base::Meas::MeasurementValue*>(BaseClass_ptr2) != nullptr)
		{
			element->MeasurementValue.push_back(dynamic_cast<IEC61970::Base::Meas::MeasurementValue*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_CustomerAccount_AccountNotification(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Customers::CustomerAccount* element = dynamic_cast<IEC61968::Customers::CustomerAccount*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Customers::AccountNotification*>(BaseClass_ptr2) != nullptr)
		{
			element->AccountNotification.push_back(dynamic_cast<IEC61968::Customers::AccountNotification*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_OutageOrder_Location(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::OutageOrder* element = dynamic_cast<IEC61968::Operations::OutageOrder*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Common::Location*>(BaseClass_ptr2) != nullptr)
		{
			element->Location.push_back(dynamic_cast<IEC61968::Common::Location*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_Customer_Customers(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Customers::Customer* element = dynamic_cast<IEC61968::Customers::Customer*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Customers::Customer*>(BaseClass_ptr2) != nullptr)
		{
			element->Customers.push_back(dynamic_cast<IEC61968::Customers::Customer*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_InterrupterUnit_Bushing(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::InterrupterUnit* element = dynamic_cast<IEC61968::Assets::InterrupterUnit*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Assets::Bushing*>(BaseClass_ptr2) != nullptr)
		{
			element->Bushing.push_back(dynamic_cast<IEC61968::Assets::Bushing*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_AggregateScore_AnalyticScore(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::AggregateScore* element = dynamic_cast<IEC61968::Assets::AggregateScore*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Assets::AnalyticScore*>(BaseClass_ptr2) != nullptr)
		{
			element->AnalyticScore.push_back(dynamic_cast<IEC61968::Assets::AnalyticScore*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_OperatingMechanism_InterrupterUnit(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::OperatingMechanism* element = dynamic_cast<IEC61968::Assets::OperatingMechanism*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Assets::InterrupterUnit*>(BaseClass_ptr2) != nullptr)
		{
			element->InterrupterUnit.push_back(dynamic_cast<IEC61968::Assets::InterrupterUnit*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_AssetGroup_AnalyticScore(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::AssetGroup* element = dynamic_cast<IEC61968::Assets::AssetGroup*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Assets::AnalyticScore*>(BaseClass_ptr2) != nullptr)
		{
			element->AnalyticScore.push_back(dynamic_cast<IEC61968::Assets::AnalyticScore*>(BaseClass_ptr2));
...
bool assign_AssetGroup_Asset(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::AssetGroup* element = dynamic_cast<IEC61968::Assets::AssetGroup*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Assets::Asset*>(BaseClass_ptr2) != nullptr)
...
bool assign_Analytic_AssetGroup(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::Analytic* element = dynamic_cast<IEC61968::Assets::Analytic*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Assets::AssetGroup*>(BaseClass_ptr2) != nullptr)
		{
			element->AssetGroup.push_back(dynamic_cast<IEC61968::Assets::AssetGroup*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_Analytic_AnalyticScore(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::Analytic* element = dynamic_cast<IEC61968::Assets::Analytic*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Assets::AnalyticScore*>(BaseClass_ptr2) != nullptr)
...
bool assign_Analytic_AssetHealthEvent(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::Analytic* element = dynamic_cast<IEC61968::Assets::Analytic*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Assets::AssetHealthEvent*>(BaseClass_ptr2) != nullptr)
		{
			element->AssetHealthEvent.push_back(dynamic_cast<IEC61968::Assets::AssetHealthEvent*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_Analytic_Asset(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Assets::Analytic* element = dynamic_cast<IEC61968::Assets::Analytic*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Assets::Asset*>(BaseClass_ptr2) != nullptr)
...
bool assign_Editor_Documents(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Common::Editor* element = dynamic_cast<IEC61968::Common::Editor*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Common::Document*>(BaseClass_ptr2) != nullptr)
		{
			element->Documents.push_back(dynamic_cast<IEC61968::Common::Document*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_Approver_Documents(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Common::Approver* element = dynamic_cast<IEC61968::Common::Approver*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Common::Document*>(BaseClass_ptr2) != nullptr)
		{
			element->Documents.push_back(dynamic_cast<IEC61968::Common::Document*>(BaseClass_ptr2));
...
bool assign_Issuer_Documents(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Common::Issuer* element = dynamic_cast<IEC61968::Common::Issuer*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Common::Document*>(BaseClass_ptr2) != nullptr)
		{
			element->Documents.push_back(dynamic_cast<IEC61968::Common::Document*>(BaseClass_ptr2));
...
bool assign_UnplannedOutage_TroubleTicket(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::UnplannedOutage* element = dynamic_cast<IEC61968::Operations::UnplannedOutage*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Customers::TroubleTicket*>(BaseClass_ptr2) != nullptr)
		{
			element->TroubleTicket.push_back(dynamic_cast<IEC61968::Customers::TroubleTicket*>(BaseClass_ptr2));
...
bool assign_FieldDispatchHistory_FieldDispatchStep(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Common::FieldDispatchHistory* element = dynamic_cast<IEC61968::Common::FieldDispatchHistory*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Common::FieldDispatchStep*>(BaseClass_ptr2) != nullptr)
		{
			element->FieldDispatchStep.push_back(dynamic_cast<IEC61968::Common::FieldDispatchStep*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_Author_Documents(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Common::Author* element = dynamic_cast<IEC61968::Common::Author*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Common::Document*>(BaseClass_ptr2) != nullptr)
		{
			element->Documents.push_back(dynamic_cast<IEC61968::Common::Document*>(BaseClass_ptr2));
...
bool assign_Author_ActivityRecords(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Common::Author* element = dynamic_cast<IEC61968::Common::Author*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Common::ActivityRecord*>(BaseClass_ptr2) != nullptr)
...
bool assign_FieldSafetySupervisor_ReleasedSafetyDocuments(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::FieldSafetySupervisor* element = dynamic_cast<IEC61968::Operations::FieldSafetySupervisor*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Operations::SafetyDocument*>(BaseClass_ptr2) != nullptr)
		{
			element->ReleasedSafetyDocuments.push_back(dynamic_cast<IEC61968::Operations::SafetyDocument*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_FieldSafetySupervisor_IssuedSafetyDocuments(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::FieldSafetySupervisor* element = dynamic_cast<IEC61968::Operations::FieldSafetySupervisor*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Operations::SafetyDocument*>(BaseClass_ptr2) != nullptr)
		{
			element->IssuedSafetyDocuments.push_back(dynamic_cast<IEC61968::Operations::SafetyDocument*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_EstimatedRestorationTime_Outage(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::EstimatedRestorationTime* element = dynamic_cast<IEC61968::Operations::EstimatedRestorationTime*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Operations::Outage*>(BaseClass_ptr2) != nullptr)
		{
			element->Outage.push_back(dynamic_cast<IEC61968::Operations::Outage*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_OperationsSafetySupervisor_ReleasedSafetyDocuments(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::OperationsSafetySupervisor* element = dynamic_cast<IEC61968::Operations::OperationsSafetySupervisor*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Operations::SafetyDocument*>(BaseClass_ptr2) != nullptr)
		{
			element->ReleasedSafetyDocuments.push_back(dynamic_cast<IEC61968::Operations::SafetyDocument*>(BaseClass_ptr2));
...
bool assign_OperationsSafetySupervisor_IssuedSafetyDocuments(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::OperationsSafetySupervisor* element = dynamic_cast<IEC61968::Operations::OperationsSafetySupervisor*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Operations::SafetyDocument*>(BaseClass_ptr2) != nullptr)
...
bool assign_OutageArea_Outage(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::Operations::OutageArea* element = dynamic_cast<IEC61968::Operations::OutageArea*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::Operations::Outage*>(BaseClass_ptr2) != nullptr)
		{
			element->Outage.push_back(dynamic_cast<IEC61968::Operations::Outage*>(BaseClass_ptr2));
...
bool assign_Pole_Streetlights(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	...
	{
		if(dynamic_cast<IEC61968::Assets::Streetlight*>(BaseClass_ptr2) != nullptr)
		{
			element->Streetlights.push_back(dynamic_cast<IEC61968::Assets::Streetlight*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_StatisticalCalculation_CalculationMethodOrder(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61968::AssetMeas::StatisticalCalculation* element = dynamic_cast<IEC61968::AssetMeas::StatisticalCalculation*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61968::AssetMeas::CalculationMethodOrder*>(BaseClass_ptr2) != nullptr)
		{
			element->CalculationMethodOrder.push_back(dynamic_cast<IEC61968::AssetMeas::CalculationMethodOrder*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_EquipmentContainer_AdditionalGroupedEquipment(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Base::Core::EquipmentContainer* element = dynamic_cast<IEC61970::Base::Core::EquipmentContainer*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61970::Base::Core::Equipment*>(BaseClass_ptr2) != nullptr)
		{
			element->AdditionalGroupedEquipment.push_back(dynamic_cast<IEC61970::Base::Core::Equipment*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_DCEquipmentContainer_DCTopologicalNode(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	...
	{
		if(dynamic_cast<IEC61970::Base::DC::DCTopologicalNode*>(BaseClass_ptr2) != nullptr)
		{
			element->DCTopologicalNode.push_back(dynamic_cast<IEC61970::Base::DC::DCTopologicalNode*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_DCTopologicalIsland_DCTopologicalNodes(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Base::DC::DCTopologicalIsland* element = dynamic_cast<IEC61970::Base::DC::DCTopologicalIsland*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61970::Base::DC::DCTopologicalNode*>(BaseClass_ptr2) != nullptr)
		{
			element->DCTopologicalNodes.push_back(dynamic_cast<IEC61970::Base::DC::DCTopologicalNode*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_Feeder_NamingSecondarySubstation(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Base::Core::Feeder* element = dynamic_cast<IEC61970::Base::Core::Feeder*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61970::Base::Core::Substation*>(BaseClass_ptr2) != nullptr)
		{
			element->NamingSecondarySubstation.push_back(dynamic_cast<IEC61970::Base::Core::Substation*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_Feeder_NormalHeadTerminal(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Base::Core::Feeder* element = dynamic_cast<IEC61970::Base::Core::Feeder*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61970::Base::Core::Terminal*>(BaseClass_ptr2) != nullptr)
		{
			element->NormalHeadTerminal.push_back(dynamic_cast<IEC61970::Base::Core::Terminal*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_Feeder_NormalEnergizedSubstation(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Base::Core::Feeder* element = dynamic_cast<IEC61970::Base::Core::Feeder*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61970::Base::Core::Substation*>(BaseClass_ptr2) != nullptr)
		{
			element->NormalEnergizedSubstation.push_back(dynamic_cast<IEC61970::Base::Core::Substation*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_Substation_NormalEnergizedFeeder(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Base::Core::Substation* element = dynamic_cast<IEC61970::Base::Core::Substation*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61970::Base::Core::Feeder*>(BaseClass_ptr2) != nullptr)
		{
			element->NormalEnergizedFeeder.push_back(dynamic_cast<IEC61970::Base::Core::Feeder*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
{
	if(IEC61970::Base::Wires::PowerElectronicsConnection* element = dynamic_cast<IEC61970::Base::Wires::PowerElectronicsConnection*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61970::Base::Generation::Production::PowerElectronicsUnit*>(BaseClass_ptr2) != nullptr)
		{
			element->PowerElectronicsUnit.push_back(dynamic_cast<IEC61970::Base::Generation::Production::PowerElectronicsUnit*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_ICCPInformationMessage_TASE2BilateralTable(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Base::ICCPConfiguration::ICCPInformationMessage* element = dynamic_cast<IEC61970::Base::ICCPConfiguration::ICCPInformationMessage*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61970::Base::ICCPConfiguration::TASE2BilateralTable*>(BaseClass_ptr2) != nullptr)
		{
			element->TASE2BilateralTable.push_back(dynamic_cast<IEC61970::Base::ICCPConfiguration::TASE2BilateralTable*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_IOPointSource_IOPoint(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Base::ICCPConfiguration::IOPointSource* element = dynamic_cast<IEC61970::Base::ICCPConfiguration::IOPointSource*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61970::Base::Meas::IOPoint*>(BaseClass_ptr2) != nullptr)
		{
			element->IOPoint.push_back(dynamic_cast<IEC61970::Base::Meas::IOPoint*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_Model_Supersedes(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Part552Header::ModelDescription::Model* element = dynamic_cast<IEC61970::Part552Header::ModelDescription::Model*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61970::Part552Header::ModelDescription::Model*>(BaseClass_ptr2) != nullptr)
		{
			element->Supersedes.push_back(dynamic_cast<IEC61970::Part552Header::ModelDescription::Model*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_Model_DependentOn(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Part552Header::ModelDescription::Model* element = dynamic_cast<IEC61970::Part552Header::ModelDescription::Model*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61970::Part552Header::ModelDescription::Model*>(BaseClass_ptr2) != nullptr)
		{
			element->DependentOn.push_back(dynamic_cast<IEC61970::Part552Header::ModelDescription::Model*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
bool assign_DataSet_Profile(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Part303::GenericDataset::DataSet* element = dynamic_cast<IEC61970::Part303::GenericDataset::DataSet*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61970::Part303::GenericDataset::Profile*>(BaseClass_ptr2) != nullptr)
		{
			element->Profile.push_back(dynamic_cast<IEC61970::Part303::GenericDataset::Profile*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
static std::unordered_map<std::string, bool (*)(BaseClass*, BaseClass*)> initialize()
{
	...
	map.insert(std::make_pair("cim:ProvidedBilateralPoint.BilateralExchangeActor", &assign_ProvidedBilateralPoint_BilateralExchangeActor));
	map.insert(std::make_pair("cim:BilateralExchangeActor.ProvidedBilateralPoint", &assign_ProvidedBilateralPoint_BilateralExchangeActor));
	...
	map.insert(std::make_pair("cim:ConfigurationEvent.FaultCauseType", &assign_ConfigurationEvent_FaultCauseType));
	map.insert(std::make_pair("cim:FaultCauseType.ConfigurationEvent", &assign_ConfigurationEvent_FaultCauseType));
	...
	map.insert(std::make_pair("cim:AssetInfo.CatalogAssetType", &assign_AssetInfo_CatalogAssetType));
	map.insert(std::make_pair("cim:CatalogAssetType.AssetInfo", &assign_AssetInfo_CatalogAssetType));
	...
	map.insert(std::make_pair("cim:WirePhaseInfo.WireAssemblyInfo", &assign_WirePhaseInfo_WireAssemblyInfo));
	map.insert(std::make_pair("cim:WireAssemblyInfo.WirePhaseInfo", &assign_WirePhaseInfo_WireAssemblyInfo));
	...
	map.insert(std::make_pair("cim:Organisation.ParentOrganisation", &assign_Organisation_ParentOrganisation));
	map.insert(std::make_pair("cim:ParentOrganisation.Organisation", &assign_Organisation_ParentOrganisation));
	...
	map.insert(std::make_pair("cim:AssetDeployment.BaseVoltage", &assign_AssetDeployment_BaseVoltage));
	map.insert(std::make_pair("cim:BaseVoltage.AssetDeployment", &assign_AssetDeployment_BaseVoltage));
	...
	map.insert(std::make_pair("cim:Fault.Location", &assign_Fault_Location));
	map.insert(std::make_pair("cim:Location.Fault", &assign_Fault_Location));
	...
	map.insert(std::make_pair("cim:ConsumptionTariffInterval.ReadingType", &assign_ConsumptionTariffInterval_ReadingType));
	map.insert(std::make_pair("cim:ReadingType.ConsumptionTariffInterval", &assign_ConsumptionTariffInterval_ReadingType));
	...
	map.insert(std::make_pair("cim:SwitchingAction.Operator", &assign_SwitchingAction_Operator));
	map.insert(std::make_pair("cim:Operator.SwitchingAction", &assign_SwitchingAction_Operator));
	...
	map.insert(std::make_pair("cim:SwitchingPlan.OutagePlan", &assign_SwitchingPlan_OutagePlan));
	map.insert(std::make_pair("cim:OutagePlan.SwitchingPlan", &assign_SwitchingPlan_OutagePlan));
	map.insert(std::make_pair("cim:SwitchingOrder.SwitchingPlan", &assign_SwitchingOrder_SwitchingPlan));
	map.insert(std::make_pair("cim:SwitchingPlan.SwitchingOrder", &assign_SwitchingOrder_SwitchingPlan));
	...
	map.insert(std::make_pair("cim:Location.SwitchingOrder", &assign_Location_SwitchingOrder));
	map.insert(std::make_pair("cim:SwitchingOrder.Location", &assign_Location_SwitchingOrder));
	...
	map.insert(std::make_pair("cim:CatalogAssetType.TypeAssetCatalogue", &assign_CatalogAssetType_TypeAssetCatalogue));
	map.insert(std::make_pair("cim:TypeAssetCatalogue.CatalogAssetType", &assign_CatalogAssetType_TypeAssetCatalogue));
	map.insert(std::make_pair("cim:ProductAssetModel.AssetInfo", &assign_ProductAssetModel_AssetInfo));
	map.insert(std::make_pair("cim:AssetInfo.ProductAssetModel", &assign_ProductAssetModel_AssetInfo));
	...
	map.insert(std::make_pair("cim:ProductAssetModel.CatalogAssetType", &assign_ProductAssetModel_CatalogAssetType));
	map.insert(std::make_pair("cim:CatalogAssetType.ProductAssetModel", &assign_ProductAssetModel_CatalogAssetType));
	...
	map.insert(std::make_pair("cim:Asset.AssetDeployment", &assign_Asset_AssetDeployment));
	map.insert(std::make_pair("cim:AssetDeployment.Asset", &assign_Asset_AssetDeployment));
	...
	map.insert(std::make_pair("cim:Asset.ProductAssetModel", &assign_Asset_ProductAssetModel));
	map.insert(std::make_pair("cim:ProductAssetModel.Asset", &assign_Asset_ProductAssetModel));
	...
	map.insert(std::make_pair("cim:WireSpacing.DuctBank", &assign_WireSpacing_DuctBank));
	map.insert(std::make_pair("cim:DuctBank.WireSpacing", &assign_WireSpacing_DuctBank));
	...
	map.insert(std::make_pair("cim:EndDeviceGroup.DispatchablePowerCapability", &assign_EndDeviceGroup_DispatchablePowerCapability));
	map.insert(std::make_pair("cim:DispatchablePowerCapability.EndDeviceGroup", &assign_EndDeviceGroup_DispatchablePowerCapability));
	map.insert(std::make_pair("cim:DispatchSchedule.DERMonitorableParameter", &assign_DispatchSchedule_DERMonitorableParameter));
	map.insert(std::make_pair("cim:DERMonitorableParameter.DispatchSchedule", &assign_DispatchSchedule_DERMonitorableParameter));
	map.insert(std::make_pair("cim:DERCurveData.DispatchSchedule", &assign_DERCurveData_DispatchSchedule));
	map.insert(std::make_pair("cim:DispatchSchedule.DERCurveData", &assign_DERCurveData_DispatchSchedule));
	map.insert(std::make_pair("cim:DERCurveData.DERMonitorableParameter", &assign_DERCurveData_DERMonitorableParameter));
	map.insert(std::make_pair("cim:DERMonitorableParameter.DERCurveData", &assign_DERCurveData_DERMonitorableParameter));
	...
	map.insert(std::make_pair("cim:Incident.Location", &assign_Incident_Location));
	map.insert(std::make_pair("cim:Location.Incident", &assign_Incident_Location));
	...
	map.insert(std::make_pair("cim:MeterWorkTask.UsagePoint", &assign_MeterWorkTask_UsagePoint));
	map.insert(std::make_pair("cim:UsagePoint.MeterWorkTask", &assign_MeterWorkTask_UsagePoint));
	map.insert(std::make_pair("cim:MeterWorkTask.Meter", &assign_MeterWorkTask_Meter));
	map.insert(std::make_pair("cim:Meter.MeterWorkTask", &assign_MeterWorkTask_Meter));
	map.insert(std::make_pair("cim:MeterWorkTask.OldMeter", &assign_MeterWorkTask_OldMeter));
	map.insert(std::make_pair("cim:OldMeter.MeterWorkTask", &assign_MeterWorkTask_OldMeter));
	...
	map.insert(std::make_pair("cim:ProcedureDataSet.Asset", &assign_ProcedureDataSet_Asset));
	map.insert(std::make_pair("cim:Asset.ProcedureDataSet", &assign_ProcedureDataSet_Asset));
	map.insert(std::make_pair("cim:ProcedureDataSet.WorkTask", &assign_ProcedureDataSet_WorkTask));
	map.insert(std::make_pair("cim:WorkTask.ProcedureDataSet", &assign_ProcedureDataSet_WorkTask));
	...
	map.insert(std::make_pair("cim:OutagePlan.OutageOrder", &assign_OutagePlan_OutageOrder));
	map.insert(std::make_pair("cim:OutageOrder.OutagePlan", &assign_OutagePlan_OutageOrder));
	map.insert(std::make_pair("cim:OutagePlan.PlannedOutage", &assign_OutagePlan_PlannedOutage));
	map.insert(std::make_pair("cim:PlannedOutage.OutagePlan", &assign_OutagePlan_PlannedOutage));
	map.insert(std::make_pair("cim:Customer.OutagePlan", &assign_Customer_OutagePlan));
	map.insert(std::make_pair("cim:OutagePlan.Customer", &assign_Customer_OutagePlan));
	map.insert(std::make_pair("cim:AnalyticScore.Asset", &assign_AnalyticScore_Asset));
	map.insert(std::make_pair("cim:Asset.AnalyticScore", &assign_AnalyticScore_Asset));
	...
	map.insert(std::make_pair("cim:Specimen.AssetTestSampleTaker", &assign_Specimen_AssetTestSampleTaker));
	map.insert(std::make_pair("cim:AssetTestSampleTaker.Specimen", &assign_Specimen_AssetTestSampleTaker));
	map.insert(std::make_pair("cim:LabTestDataSet.Specimen", &assign_LabTestDataSet_Specimen));
	map.insert(std::make_pair("cim:Specimen.LabTestDataSet", &assign_LabTestDataSet_Specimen));
	map.insert(std::make_pair("cim:LabTestDataSet.AssetTestLab", &assign_LabTestDataSet_AssetTestLab));
	map.insert(std::make_pair("cim:AssetTestLab.LabTestDataSet", &assign_LabTestDataSet_AssetTestLab));
	map.insert(std::make_pair("cim:HealthScore.AssetRiskScore", &assign_HealthScore_AssetRiskScore));
	map.insert(std::make_pair("cim:AssetRiskScore.HealthScore", &assign_HealthScore_AssetRiskScore));
	...
	map.insert(std::make_pair("cim:SwitchOperationSummary.Breaker", &assign_SwitchOperationSummary_Breaker));
	map.insert(std::make_pair("cim:Breaker.SwitchOperationSummary", &assign_SwitchOperationSummary_Breaker));
	...
	map.insert(std::make_pair("cim:FieldDispatchHistory.UnplannedOutage", &assign_FieldDispatchHistory_UnplannedOutage));
	map.insert(std::make_pair("cim:UnplannedOutage.FieldDispatchHistory", &assign_FieldDispatchHistory_UnplannedOutage));
	map.insert(std::make_pair("cim:FieldDispatchHistory.PlannedOutage", &assign_FieldDispatchHistory_PlannedOutage));
	map.insert(std::make_pair("cim:PlannedOutage.FieldDispatchHistory", &assign_FieldDispatchHistory_PlannedOutage));
	map.insert(std::make_pair("cim:FieldDispatchHistory.Crew", &assign_FieldDispatchHistory_Crew));
	map.insert(std::make_pair("cim:Crew.FieldDispatchHistory", &assign_FieldDispatchHistory_Crew));
	...
	map.insert(std::make_pair("cim:TroubleOrder.Incident", &assign_TroubleOrder_Incident));
	map.insert(std::make_pair("cim:Incident.TroubleOrder", &assign_TroubleOrder_Incident));
	map.insert(std::make_pair("cim:TroubleOrder.Location", &assign_TroubleOrder_Location));
	map.insert(std::make_pair("cim:Location.TroubleOrder", &assign_TroubleOrder_Location));
	map.insert(std::make_pair("cim:OperationalTag.PowerSystemResource", &assign_OperationalTag_PowerSystemResource));
	map.insert(std::make_pair("cim:PowerSystemResource.OperationalTag", &assign_OperationalTag_PowerSystemResource));
	map.insert(std::make_pair("cim:OperationalTag.Asset", &assign_OperationalTag_Asset));
	map.insert(std::make_pair("cim:Asset.OperationalTag", &assign_OperationalTag_Asset));
	...
	map.insert(std::make_pair("cim:MeasurementAction.Measurement", &assign_MeasurementAction_Measurement));
	map.insert(std::make_pair("cim:Measurement.MeasurementAction", &assign_MeasurementAction_Measurement));
	map.insert(std::make_pair("cim:GenericAction.PowerSystemResource", &assign_GenericAction_PowerSystemResource));
	map.insert(std::make_pair("cim:PowerSystemResource.GenericAction", &assign_GenericAction_PowerSystemResource));
	...
	map.insert(std::make_pair("cim:VerificationAction.PowerSystemResource", &assign_VerificationAction_PowerSystemResource));
	map.insert(std::make_pair("cim:PowerSystemResource.VerificationAction", &assign_VerificationAction_PowerSystemResource));
	map.insert(std::make_pair("cim:TagAction.OperationalTag", &assign_TagAction_OperationalTag));
	map.insert(std::make_pair("cim:OperationalTag.TagAction", &assign_TagAction_OperationalTag));
	map.insert(std::make_pair("cim:SwitchingStep.SwitchingStepGroup", &assign_SwitchingStep_SwitchingStepGroup));
	map.insert(std::make_pair("cim:SwitchingStepGroup.SwitchingStep", &assign_SwitchingStep_SwitchingStepGroup));
	map.insert(std::make_pair("cim:SwitchingStep.SwitchingAction", &assign_SwitchingStep_SwitchingAction));
	map.insert(std::make_pair("cim:SwitchingAction.SwitchingStep", &assign_SwitchingStep_SwitchingAction));
	map.insert(std::make_pair("cim:ControlAction.Control", &assign_ControlAction_Control));
	map.insert(std::make_pair("cim:Control.ControlAction", &assign_ControlAction_Control));
	...
	map.insert(std::make_pair("cim:CompatibleUnit.GenericAssetModel", &assign_CompatibleUnit_GenericAssetModel));
	map.insert(std::make_pair("cim:GenericAssetModel.CompatibleUnit", &assign_CompatibleUnit_GenericAssetModel));
	...
	map.insert(std::make_pair("cim:ErpLedgerEntry.ErpLedBudLineItem", &assign_ErpLedgerEntry_ErpLedBudLineItem));
	map.insert(std::make_pair("cim:ErpLedBudLineItem.ErpLedgerEntry", &assign_ErpLedgerEntry_ErpLedBudLineItem));
	...
	map.insert(std::make_pair("cim:AssetDiscrete.TestStandard", &assign_AssetDiscrete_TestStandard));
	map.insert(std::make_pair("cim:TestStandard.AssetDiscrete", &assign_AssetDiscrete_TestStandard));
	...
	map.insert(std::make_pair("cim:AssetAnalog.TestStandard", &assign_AssetAnalog_TestStandard));
	map.insert(std::make_pair("cim:TestStandard.AssetAnalog", &assign_AssetAnalog_TestStandard));
	map.insert(std::make_pair("cim:CalculationMethodHierarchy.MeasurementValue", &assign_CalculationMethodHierarchy_MeasurementValue));
	map.insert(std::make_pair("cim:MeasurementValue.CalculationMethodHierarchy", &assign_CalculationMethodHierarchy_MeasurementValue));
	map.insert(std::make_pair("cim:CalculationMethodOrder.CalculationMethodHierarchy", &assign_CalculationMethodOrder_CalculationMethodHierarchy));
	map.insert(std::make_pair("cim:CalculationMethodHierarchy.CalculationMethodOrder", &assign_CalculationMethodOrder_CalculationMethodHierarchy));
	map.insert(std::make_pair("cim:AssetStringMeasurement.TestStandard", &assign_AssetStringMeasurement_TestStandard));
	map.insert(std::make_pair("cim:TestStandard.AssetStringMeasurement", &assign_AssetStringMeasurement_TestStandard));
	...
	map.insert(std::make_pair("cim:BusNameMarker.TopologicalNode", &assign_BusNameMarker_TopologicalNode));
	map.insert(std::make_pair("cim:TopologicalNode.BusNameMarker", &assign_BusNameMarker_TopologicalNode));
	...
	map.insert(std::make_pair("cim:CommunicationLink.BilateralExchangeActor", &assign_CommunicationLink_BilateralExchangeActor));
	map.insert(std::make_pair("cim:BilateralExchangeActor.CommunicationLink", &assign_CommunicationLink_BilateralExchangeActor));
	...
	map.insert(std::make_pair("cim:BilateralExchangeAgreement.Provider", &assign_BilateralExchangeAgreement_Provider));
	map.insert(std::make_pair("cim:Provider.BilateralExchangeAgreement", &assign_BilateralExchangeAgreement_Provider));
	map.insert(std::make_pair("cim:BilateralExchangeAgreement.Consumer", &assign_BilateralExchangeAgreement_Consumer));
	map.insert(std::make_pair("cim:Consumer.BilateralExchangeAgreement", &assign_BilateralExchangeAgreement_Consumer));
	map.insert(std::make_pair("cim:PublicX509Certificate.TCPAccessPoint", &assign_PublicX509Certificate_TCPAccessPoint));
	map.insert(std::make_pair("cim:TCPAccessPoint.PublicX509Certificate", &assign_PublicX509Certificate_TCPAccessPoint));
	map.insert(std::make_pair("cim:PublicX509Certificate.ISOUpperLayer", &assign_PublicX509Certificate_ISOUpperLayer));
	map.insert(std::make_pair("cim:ISOUpperLayer.PublicX509Certificate", &assign_PublicX509Certificate_ISOUpperLayer));
	...
	map.insert(std::make_pair("cim:DifferenceModel.reverseDifferences", &assign_DifferenceModel_reverseDifferences));
	map.insert(std::make_pair("cim:reverseDifferences.DifferenceModel", &assign_DifferenceModel_reverseDifferences));
	map.insert(std::make_pair("cim:DifferenceModel.forwardDifferences", &assign_DifferenceModel_forwardDifferences));
	map.insert(std::make_pair("cim:forwardDifferences.DifferenceModel", &assign_DifferenceModel_forwardDifferences));
	map.insert(std::make_pair("cim:DataSetMember.PropertiesObject", &assign_DataSetMember_PropertiesObject));
	map.insert(std::make_pair("cim:PropertiesObject.DataSetMember", &assign_DataSetMember_PropertiesObject));
	map.insert(std::make_pair("cim:DataSetMember.TargetObject", &assign_DataSetMember_TargetObject));
	map.insert(std::make_pair("cim:TargetObject.DataSetMember", &assign_DataSetMember_TargetObject));
	map.insert(std::make_pair("cim:ChangeSetMember.Changeset", &assign_ChangeSetMember_Changeset));
	map.insert(std::make_pair("cim:Changeset.ChangeSetMember", &assign_ChangeSetMember_Changeset));
	map.insert(std::make_pair("cim:ObjectReverseModification.ObjectModification", &assign_ObjectReverseModification_ObjectModification));
	map.insert(std::make_pair("cim:ObjectModification.ObjectReverseModification", &assign_ObjectReverseModification_ObjectModification));
	map.insert(std::make_pair("cim:InstanceSetMember.InstanceSet", &assign_InstanceSetMember_InstanceSet));
	map.insert(std::make_pair("cim:InstanceSet.InstanceSetMember", &assign_InstanceSetMember_InstanceSet));
	...
	map.insert(std::make_pair("cim:WindTurbineType3or4Dynamics.PowerElectronicsConnection", &assign_WindTurbineType3or4Dynamics_PowerElectronicsConnection));
	map.insert(std::make_pair("cim:PowerElectronicsConnection.WindTurbineType3or4Dynamics", &assign_WindTurbineType3or4Dynamics_PowerElectronicsConnection));
	...
	map.insert(std::make_pair("cim:BilateralExchangeActor.ProviderBilateralExchange", &assign_BilateralExchangeActor_ProviderBilateralExchange));
	map.insert(std::make_pair("cim:ProviderBilateralExchange.BilateralExchangeActor", &assign_BilateralExchangeActor_ProviderBilateralExchange));
	map.insert(std::make_pair("cim:IOPoint.BilateralToIOPoint", &assign_IOPoint_BilateralToIOPoint));
	map.insert(std::make_pair("cim:BilateralToIOPoint.IOPoint", &assign_IOPoint_BilateralToIOPoint));
	...
	map.insert(std::make_pair("cim:PowerSystemResource.ConfigurationEvent", &assign_PowerSystemResource_ConfigurationEvent));
	map.insert(std::make_pair("cim:ConfigurationEvent.PowerSystemResource", &assign_PowerSystemResource_ConfigurationEvent));
	...
	map.insert(std::make_pair("cim:WireAssemblyInfo.PerLengthLineParameter", &assign_WireAssemblyInfo_PerLengthLineParameter));
	map.insert(std::make_pair("cim:PerLengthLineParameter.WireAssemblyInfo", &assign_WireAssemblyInfo_PerLengthLineParameter));
	map.insert(std::make_pair("cim:WireInfo.WirePhaseInfo", &assign_WireInfo_WirePhaseInfo));
	map.insert(std::make_pair("cim:WirePhaseInfo.WireInfo", &assign_WireInfo_WirePhaseInfo));
	...
	map.insert(std::make_pair("cim:WirePosition.WirePhaseInfo", &assign_WirePosition_WirePhaseInfo));
	map.insert(std::make_pair("cim:WirePhaseInfo.WirePosition", &assign_WirePosition_WirePhaseInfo));
	...
	map.insert(std::make_pair("cim:SwitchingAction.Crew", &assign_SwitchingAction_Crew));
	map.insert(std::make_pair("cim:Crew.SwitchingAction", &assign_SwitchingAction_Crew));
	...
	map.insert(std::make_pair("cim:Outage.DeEnergizedUsagePoint", &assign_Outage_DeEnergizedUsagePoint));
	map.insert(std::make_pair("cim:DeEnergizedUsagePoint.Outage", &assign_Outage_DeEnergizedUsagePoint));
	...
	map.insert(std::make_pair("cim:Outage.EnergizedUsagePoint", &assign_Outage_EnergizedUsagePoint));
	map.insert(std::make_pair("cim:EnergizedUsagePoint.Outage", &assign_Outage_EnergizedUsagePoint));
	...
	map.insert(std::make_pair("cim:Outage.Crew", &assign_Outage_Crew));
	map.insert(std::make_pair("cim:Crew.Outage", &assign_Outage_Crew));
	...
	map.insert(std::make_pair("cim:Location.Crew", &assign_Location_Crew));
	map.insert(std::make_pair("cim:Crew.Location", &assign_Location_Crew));
	...
	map.insert(std::make_pair("cim:BaseWork.WorkActivityRecords", &assign_BaseWork_WorkActivityRecords));
	map.insert(std::make_pair("cim:WorkActivityRecords.BaseWork", &assign_BaseWork_WorkActivityRecords));
	...
	map.insert(std::make_pair("cim:Medium.Asset", &assign_Medium_Asset));
	map.insert(std::make_pair("cim:Asset.Medium", &assign_Medium_Asset));
	...
	map.insert(std::make_pair("cim:CatalogAssetType.ErpReqLineItems", &assign_CatalogAssetType_ErpReqLineItems));
	map.insert(std::make_pair("cim:ErpReqLineItems.CatalogAssetType", &assign_CatalogAssetType_ErpReqLineItems));
	map.insert(std::make_pair("cim:CatalogAssetType.ErpBomItemDatas", &assign_CatalogAssetType_ErpBomItemDatas));
	map.insert(std::make_pair("cim:ErpBomItemDatas.CatalogAssetType", &assign_CatalogAssetType_ErpBomItemDatas));
	...
	map.insert(std::make_pair("cim:Asset.AssetFunction", &assign_Asset_AssetFunction));
	map.insert(std::make_pair("cim:AssetFunction.Asset", &assign_Asset_AssetFunction));
	...
	map.insert(std::make_pair("cim:WireSpacing.WirePositions", &assign_WireSpacing_WirePositions));
	map.insert(std::make_pair("cim:WirePositions.WireSpacing", &assign_WireSpacing_WirePositions));
	map.insert(std::make_pair("cim:WireSpacing.Structures", &assign_WireSpacing_Structures));
	map.insert(std::make_pair("cim:Structures.WireSpacing", &assign_WireSpacing_Structures));
	map.insert(std::make_pair("cim:RepairItem.RepairWorkTask", &assign_RepairItem_RepairWorkTask));
	map.insert(std::make_pair("cim:RepairWorkTask.RepairItem", &assign_RepairItem_RepairWorkTask));
	...
	map.insert(std::make_pair("cim:EndDevice.DispatchablePowerCapability", &assign_EndDevice_DispatchablePowerCapability));
	map.insert(std::make_pair("cim:DispatchablePowerCapability.EndDevice", &assign_EndDevice_DispatchablePowerCapability));
	...
	map.insert(std::make_pair("cim:EndDeviceGroup.DERGroupDispatch", &assign_EndDeviceGroup_DERGroupDispatch));
	map.insert(std::make_pair("cim:DERGroupDispatch.EndDeviceGroup", &assign_EndDeviceGroup_DERGroupDispatch));
	map.insert(std::make_pair("cim:EndDeviceGroup.DERMonitorableParameter", &assign_EndDeviceGroup_DERMonitorableParameter));
	map.insert(std::make_pair("cim:DERMonitorableParameter.EndDeviceGroup", &assign_EndDeviceGroup_DERMonitorableParameter));
	map.insert(std::make_pair("cim:DERGroupForecast.EndDeviceGroup", &assign_DERGroupForecast_EndDeviceGroup));
	map.insert(std::make_pair("cim:EndDeviceGroup.DERGroupForecast", &assign_DERGroupForecast_EndDeviceGroup));
	map.insert(std::make_pair("cim:DERFunction.EndDeviceGroup", &assign_DERFunction_EndDeviceGroup));
	map.insert(std::make_pair("cim:EndDeviceGroup.DERFunction", &assign_DERFunction_EndDeviceGroup));
	...
	map.insert(std::make_pair("cim:Incident.IncidentHazard", &assign_Incident_IncidentHazard));
	map.insert(std::make_pair("cim:IncidentHazard.Incident", &assign_Incident_IncidentHazard));
	...
	map.insert(std::make_pair("cim:TroubleTicket.IncidentHazard", &assign_TroubleTicket_IncidentHazard));
	map.insert(std::make_pair("cim:IncidentHazard.TroubleTicket", &assign_TroubleTicket_IncidentHazard));
	...
	map.insert(std::make_pair("cim:ServiceLocation.TroubleTicket", &assign_ServiceLocation_TroubleTicket));
	map.insert(std::make_pair("cim:TroubleTicket.ServiceLocation", &assign_ServiceLocation_TroubleTicket));
	...
	map.insert(std::make_pair("cim:ProcedureDataSet.MeasurementValue", &assign_ProcedureDataSet_MeasurementValue));
	map.insert(std::make_pair("cim:MeasurementValue.ProcedureDataSet", &assign_ProcedureDataSet_MeasurementValue));
	...
	map.insert(std::make_pair("cim:CustomerAccount.AccountNotification", &assign_CustomerAccount_AccountNotification));
	map.insert(std::make_pair("cim:AccountNotification.CustomerAccount", &assign_CustomerAccount_AccountNotification));
	...
	map.insert(std::make_pair("cim:OutageOrder.Location", &assign_OutageOrder_Location));
	map.insert(std::make_pair("cim:Location.OutageOrder", &assign_OutageOrder_Location));
	...
	map.insert(std::make_pair("cim:Customer.Customers", &assign_Customer_Customers));
	map.insert(std::make_pair("cim:Customers.Customer", &assign_Customer_Customers));
	...
	map.insert(std::make_pair("cim:InterrupterUnit.Bushing", &assign_InterrupterUnit_Bushing));
	map.insert(std::make_pair("cim:Bushing.InterrupterUnit", &assign_InterrupterUnit_Bushing));
	map.insert(std::make_pair("cim:AggregateScore.AnalyticScore", &assign_AggregateScore_AnalyticScore));
	map.insert(std::make_pair("cim:AnalyticScore.AggregateScore", &assign_AggregateScore_AnalyticScore));
	map.insert(std::make_pair("cim:OperatingMechanism.InterrupterUnit", &assign_OperatingMechanism_InterrupterUnit));
	map.insert(std::make_pair("cim:InterrupterUnit.OperatingMechanism", &assign_OperatingMechanism_InterrupterUnit));
	...
	map.insert(std::make_pair("cim:AssetGroup.AnalyticScore", &assign_AssetGroup_AnalyticScore));
	map.insert(std::make_pair("cim:AnalyticScore.AssetGroup", &assign_AssetGroup_AnalyticScore));
	map.insert(std::make_pair("cim:AssetGroup.Asset", &assign_AssetGroup_Asset));
	map.insert(std::make_pair("cim:Asset.AssetGroup", &assign_AssetGroup_Asset));
	map.insert(std::make_pair("cim:Analytic.AssetGroup", &assign_Analytic_AssetGroup));
	map.insert(std::make_pair("cim:AssetGroup.Analytic", &assign_Analytic_AssetGroup));
	map.insert(std::make_pair("cim:Analytic.AnalyticScore", &assign_Analytic_AnalyticScore));
	map.insert(std::make_pair("cim:AnalyticScore.Analytic", &assign_Analytic_AnalyticScore));
	map.insert(std::make_pair("cim:Analytic.AssetHealthEvent", &assign_Analytic_AssetHealthEvent));
	map.insert(std::make_pair("cim:AssetHealthEvent.Analytic", &assign_Analytic_AssetHealthEvent));
	map.insert(std::make_pair("cim:Analytic.Asset", &assign_Analytic_Asset));
	map.insert(std::make_pair("cim:Asset.Analytic", &assign_Analytic_Asset));
	map.insert(std::make_pair("cim:Editor.Documents", &assign_Editor_Documents));
	map.insert(std::make_pair("cim:Documents.Editor", &assign_Editor_Documents));
	map.insert(std::make_pair("cim:Approver.Documents", &assign_Approver_Documents));
	map.insert(std::make_pair("cim:Documents.Approver", &assign_Approver_Documents));
	map.insert(std::make_pair("cim:Issuer.Documents", &assign_Issuer_Documents));
	map.insert(std::make_pair("cim:Documents.Issuer", &assign_Issuer_Documents));
	...
	map.insert(std::make_pair("cim:UnplannedOutage.TroubleTicket", &assign_UnplannedOutage_TroubleTicket));
	map.insert(std::make_pair("cim:TroubleTicket.UnplannedOutage", &assign_UnplannedOutage_TroubleTicket));
	map.insert(std::make_pair("cim:FieldDispatchHistory.FieldDispatchStep", &assign_FieldDispatchHistory_FieldDispatchStep));
	map.insert(std::make_pair("cim:FieldDispatchStep.FieldDispatchHistory", &assign_FieldDispatchHistory_FieldDispatchStep));
	map.insert(std::make_pair("cim:Author.Documents", &assign_Author_Documents));
	map.insert(std::make_pair("cim:Documents.Author", &assign_Author_Documents));
	map.insert(std::make_pair("cim:Author.ActivityRecords", &assign_Author_ActivityRecords));
	map.insert(std::make_pair("cim:ActivityRecords.Author", &assign_Author_ActivityRecords));
	map.insert(std::make_pair("cim:FieldSafetySupervisor.ReleasedSafetyDocuments", &assign_FieldSafetySupervisor_ReleasedSafetyDocuments));
	map.insert(std::make_pair("cim:ReleasedSafetyDocuments.FieldSafetySupervisor", &assign_FieldSafetySupervisor_ReleasedSafetyDocuments));
	map.insert(std::make_pair("cim:FieldSafetySupervisor.IssuedSafetyDocuments", &assign_FieldSafetySupervisor_IssuedSafetyDocuments));
	map.insert(std::make_pair("cim:IssuedSafetyDocuments.FieldSafetySupervisor", &assign_FieldSafetySupervisor_IssuedSafetyDocuments));
	...
	map.insert(std::make_pair("cim:EstimatedRestorationTime.Outage", &assign_EstimatedRestorationTime_Outage));
	map.insert(std::make_pair("cim:Outage.EstimatedRestorationTime", &assign_EstimatedRestorationTime_Outage));
	map.insert(std::make_pair("cim:OperationsSafetySupervisor.ReleasedSafetyDocuments", &assign_OperationsSafetySupervisor_ReleasedSafetyDocuments));
	map.insert(std::make_pair("cim:ReleasedSafetyDocuments.OperationsSafetySupervisor", &assign_OperationsSafetySupervisor_ReleasedSafetyDocuments));
	map.insert(std::make_pair("cim:OperationsSafetySupervisor.IssuedSafetyDocuments", &assign_OperationsSafetySupervisor_IssuedSafetyDocuments));
	map.insert(std::make_pair("cim:IssuedSafetyDocuments.OperationsSafetySupervisor", &assign_OperationsSafetySupervisor_IssuedSafetyDocuments));
	...
	map.insert(std::make_pair("cim:OutageArea.Outage", &assign_OutageArea_Outage));
	map.insert(std::make_pair("cim:Outage.OutageArea", &assign_OutageArea_Outage));
	...
	map.insert(std::make_pair("cim:StatisticalCalculation.CalculationMethodOrder", &assign_StatisticalCalculation_CalculationMethodOrder));
	map.insert(std::make_pair("cim:CalculationMethodOrder.StatisticalCalculation", &assign_StatisticalCalculation_CalculationMethodOrder));
	...
	map.insert(std::make_pair("cim:EquipmentContainer.AdditionalGroupedEquipment", &assign_EquipmentContainer_AdditionalGroupedEquipment));
	map.insert(std::make_pair("cim:AdditionalGroupedEquipment.EquipmentContainer", &assign_EquipmentContainer_AdditionalGroupedEquipment));
	...
	map.insert(std::make_pair("cim:Feeder.NamingSecondarySubstation", &assign_Feeder_NamingSecondarySubstation));
	map.insert(std::make_pair("cim:NamingSecondarySubstation.Feeder", &assign_Feeder_NamingSecondarySubstation));
	map.insert(std::make_pair("cim:Feeder.NormalHeadTerminal", &assign_Feeder_NormalHeadTerminal));
	map.insert(std::make_pair("cim:NormalHeadTerminal.Feeder", &assign_Feeder_NormalHeadTerminal));
	map.insert(std::make_pair("cim:Feeder.NormalEnergizedSubstation", &assign_Feeder_NormalEnergizedSubstation));
	map.insert(std::make_pair("cim:NormalEnergizedSubstation.Feeder", &assign_Feeder_NormalEnergizedSubstation));
	...
	map.insert(std::make_pair("cim:Substation.NormalEnergizedFeeder", &assign_Substation_NormalEnergizedFeeder));
	map.insert(std::make_pair("cim:NormalEnergizedFeeder.Substation", &assign_Substation_NormalEnergizedFeeder));
	...
	map.insert(std::make_pair("cim:PowerElectronicsConnection.PowerElectronicsUnit", &assign_PowerElectronicsConnection_PowerElectronicsUnit));
	map.insert(std::make_pair("cim:PowerElectronicsUnit.PowerElectronicsConnection", &assign_PowerElectronicsConnection_PowerElectronicsUnit));
	...
	map.insert(std::make_pair("cim:ICCPInformationMessage.TASE2BilateralTable", &assign_ICCPInformationMessage_TASE2BilateralTable));
	map.insert(std::make_pair("cim:TASE2BilateralTable.ICCPInformationMessage", &assign_ICCPInformationMessage_TASE2BilateralTable));
	map.insert(std::make_pair("cim:IOPointSource.IOPoint", &assign_IOPointSource_IOPoint));
	map.insert(std::make_pair("cim:IOPoint.IOPointSource", &assign_IOPointSource_IOPoint));
	...
	map.insert(std::make_pair("cim:Model.Supersedes", &assign_Model_Supersedes));
	map.insert(std::make_pair("cim:Supersedes.Model", &assign_Model_Supersedes));
	map.insert(std::make_pair("cim:Model.DependentOn", &assign_Model_DependentOn));
	map.insert(std::make_pair("cim:DependentOn.Model", &assign_Model_DependentOn));
	map.insert(std::make_pair("cim:DataSet.Profile", &assign_DataSet_Profile));
	map.insert(std::make_pair("cim:Profile.DataSet", &assign_DataSet_Profile));
