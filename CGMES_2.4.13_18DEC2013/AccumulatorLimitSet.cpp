...
static const std::map<std::string, AttrDetails>& getClassAttrDetailsMap()
{
	...
	{
		{ "AccumulatorLimitSet.Limits", { "http://iec.ch/TC57/2013/CIM-schema-cim16#", { CGMESProfile::EQ, } } },
		{ "AccumulatorLimitSet.Measurements", { "http://iec.ch/TC57/2013/CIM-schema-cim16#", { CGMESProfile::EQ, } } },
		{ "AccumulatorLimitSet.isPercentageLimits", { "http://iec.ch/TC57/2013/CIM-schema-cim16#", { CGMESProfile::EQ, } } },
	};
...
{
	assign_map.emplace("AccumulatorLimitSet.isPercentageLimits", &assign_AccumulatorLimitSet_isPercentageLimits);
}
...
void AccumulatorLimitSet::addPrimitiveGetFnsToMap(std::map<std::string, get_function>& get_map) const
{
	...
	get_map.emplace("AccumulatorLimitSet.isPercentageLimits", &get_AccumulatorLimitSet_isPercentageLimits);
}
