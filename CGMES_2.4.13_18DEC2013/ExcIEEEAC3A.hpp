...
namespace CIMPP {
	...
	*/
	...
	public:
					...
					CIMPP::PU vlv; 	/* Field voltage used in the minimum field voltage limiter loop (V).  Typical Value = 0.79. Default: nullptr */
					CIMPP::PU klv; 	/* Gain used in the minimum field voltage limiter loop (K).  Typical Value = 0.194. Default: nullptr */
