...
{
	factory_map.emplace("cim:ExcIEEEAC8B", &ExcIEEEAC8B_factory);
}
...
void ExcIEEEAC8B::addPrimitiveAssignFnsToMap(std::unordered_map<std::string, assign_function>& assign_map)
{
	...
	assign_map.emplace("cim:ExcIEEEAC8B.kc", &assign_ExcIEEEAC8B_kc);
	assign_map.emplace("cim:ExcIEEEAC8B.kd", &assign_ExcIEEEAC8B_kd);
	assign_map.emplace("cim:ExcIEEEAC8B.kdr", &assign_ExcIEEEAC8B_kdr);
	assign_map.emplace("cim:ExcIEEEAC8B.ke", &assign_ExcIEEEAC8B_ke);
	assign_map.emplace("cim:ExcIEEEAC8B.kir", &assign_ExcIEEEAC8B_kir);
	assign_map.emplace("cim:ExcIEEEAC8B.kpr", &assign_ExcIEEEAC8B_kpr);
	assign_map.emplace("cim:ExcIEEEAC8B.seve1", &assign_ExcIEEEAC8B_seve1);
	assign_map.emplace("cim:ExcIEEEAC8B.seve2", &assign_ExcIEEEAC8B_seve2);
	assign_map.emplace("cim:ExcIEEEAC8B.ta", &assign_ExcIEEEAC8B_ta);
	assign_map.emplace("cim:ExcIEEEAC8B.tdr", &assign_ExcIEEEAC8B_tdr);
	assign_map.emplace("cim:ExcIEEEAC8B.te", &assign_ExcIEEEAC8B_te);
	assign_map.emplace("cim:ExcIEEEAC8B.ve1", &assign_ExcIEEEAC8B_ve1);
	assign_map.emplace("cim:ExcIEEEAC8B.ve2", &assign_ExcIEEEAC8B_ve2);
	assign_map.emplace("cim:ExcIEEEAC8B.vemin", &assign_ExcIEEEAC8B_vemin);
	assign_map.emplace("cim:ExcIEEEAC8B.vfemax", &assign_ExcIEEEAC8B_vfemax);
	assign_map.emplace("cim:ExcIEEEAC8B.vrmax", &assign_ExcIEEEAC8B_vrmax);
	assign_map.emplace("cim:ExcIEEEAC8B.vrmin", &assign_ExcIEEEAC8B_vrmin);
}
