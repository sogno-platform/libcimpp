...
{
	factory_map.emplace("cim:ExcST3A", &ExcST3A_factory);
}

void ExcST3A::addPrimitiveAssignFnsToMap(std::unordered_map<std::string, assign_function>& assign_map)
{
	assign_map.emplace("cim:ExcST3A.efdmax", &assign_ExcST3A_efdmax);
	assign_map.emplace("cim:ExcST3A.kc", &assign_ExcST3A_kc);
	assign_map.emplace("cim:ExcST3A.kg", &assign_ExcST3A_kg);
	assign_map.emplace("cim:ExcST3A.ki", &assign_ExcST3A_ki);
	assign_map.emplace("cim:ExcST3A.kj", &assign_ExcST3A_kj);
	assign_map.emplace("cim:ExcST3A.km", &assign_ExcST3A_km);
	assign_map.emplace("cim:ExcST3A.kp", &assign_ExcST3A_kp);
	assign_map.emplace("cim:ExcST3A.ks", &assign_ExcST3A_ks);
	assign_map.emplace("cim:ExcST3A.ks1", &assign_ExcST3A_ks1);
	assign_map.emplace("cim:ExcST3A.tb", &assign_ExcST3A_tb);
	assign_map.emplace("cim:ExcST3A.tc", &assign_ExcST3A_tc);
	assign_map.emplace("cim:ExcST3A.thetap", &assign_ExcST3A_thetap);
	assign_map.emplace("cim:ExcST3A.tm", &assign_ExcST3A_tm);
	assign_map.emplace("cim:ExcST3A.vbmax", &assign_ExcST3A_vbmax);
	assign_map.emplace("cim:ExcST3A.vgmax", &assign_ExcST3A_vgmax);
	assign_map.emplace("cim:ExcST3A.vimax", &assign_ExcST3A_vimax);
	assign_map.emplace("cim:ExcST3A.vimin", &assign_ExcST3A_vimin);
	assign_map.emplace("cim:ExcST3A.vrmax", &assign_ExcST3A_vrmax);
	assign_map.emplace("cim:ExcST3A.vrmin", &assign_ExcST3A_vrmin);
	assign_map.emplace("cim:ExcST3A.xl", &assign_ExcST3A_xl);
}
