...
{
	{ "cim:PssIEEE4B.bwi", { CGMESProfile::DY, } },
	...
	{ "cim:PssIEEE4B.omegani", { CGMESProfile::DY, } },
...
{
	assign_map.insert(std::make_pair(std::string("cim:PssIEEE4B.bwi"), &assign_PssIEEE4B_bwi));
	...
	assign_map.insert(std::make_pair(std::string("cim:PssIEEE4B.omegani"), &assign_PssIEEE4B_omegani));
...
void PssIEEE4B::addPrimitiveGetFnsToMap(std::map<std::string, get_function>& get_map) const
{
	...
	get_map.emplace("cim:PssIEEE4B.bwi", &get_PssIEEE4B_bwi);
	...
	get_map.emplace("cim:PssIEEE4B.omegani", &get_PssIEEE4B_omegani);
