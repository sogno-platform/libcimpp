...
{
	factory_map.emplace("cim:ExcIEEEST2A", &ExcIEEEST2A_factory);
}

void ExcIEEEST2A::addPrimitiveAssignFnsToMap(std::unordered_map<std::string, assign_function>& assign_map)
{
	assign_map.emplace("cim:ExcIEEEST2A.efdmax", &assign_ExcIEEEST2A_efdmax);
	assign_map.emplace("cim:ExcIEEEST2A.ka", &assign_ExcIEEEST2A_ka);
	assign_map.emplace("cim:ExcIEEEST2A.kc", &assign_ExcIEEEST2A_kc);
	assign_map.emplace("cim:ExcIEEEST2A.ke", &assign_ExcIEEEST2A_ke);
	assign_map.emplace("cim:ExcIEEEST2A.kf", &assign_ExcIEEEST2A_kf);
	assign_map.emplace("cim:ExcIEEEST2A.ki", &assign_ExcIEEEST2A_ki);
	assign_map.emplace("cim:ExcIEEEST2A.kp", &assign_ExcIEEEST2A_kp);
	assign_map.emplace("cim:ExcIEEEST2A.ta", &assign_ExcIEEEST2A_ta);
	assign_map.emplace("cim:ExcIEEEST2A.te", &assign_ExcIEEEST2A_te);
	assign_map.emplace("cim:ExcIEEEST2A.tf", &assign_ExcIEEEST2A_tf);
	assign_map.emplace("cim:ExcIEEEST2A.uelin", &assign_ExcIEEEST2A_uelin);
	assign_map.emplace("cim:ExcIEEEST2A.vrmax", &assign_ExcIEEEST2A_vrmax);
	assign_map.emplace("cim:ExcIEEEST2A.vrmin", &assign_ExcIEEEST2A_vrmin);
}
