...
{
	factory_map.emplace("cim:GovHydroIEEE2", &GovHydroIEEE2_factory);
}

void GovHydroIEEE2::addPrimitiveAssignFnsToMap(std::unordered_map<std::string, assign_function>& assign_map)
{
	assign_map.emplace("cim:GovHydroIEEE2.aturb", &assign_GovHydroIEEE2_aturb);
	assign_map.emplace("cim:GovHydroIEEE2.bturb", &assign_GovHydroIEEE2_bturb);
	assign_map.emplace("cim:GovHydroIEEE2.gv1", &assign_GovHydroIEEE2_gv1);
	assign_map.emplace("cim:GovHydroIEEE2.gv2", &assign_GovHydroIEEE2_gv2);
	assign_map.emplace("cim:GovHydroIEEE2.gv3", &assign_GovHydroIEEE2_gv3);
	assign_map.emplace("cim:GovHydroIEEE2.gv4", &assign_GovHydroIEEE2_gv4);
	assign_map.emplace("cim:GovHydroIEEE2.gv5", &assign_GovHydroIEEE2_gv5);
	assign_map.emplace("cim:GovHydroIEEE2.gv6", &assign_GovHydroIEEE2_gv6);
	assign_map.emplace("cim:GovHydroIEEE2.kturb", &assign_GovHydroIEEE2_kturb);
	assign_map.emplace("cim:GovHydroIEEE2.mwbase", &assign_GovHydroIEEE2_mwbase);
	assign_map.emplace("cim:GovHydroIEEE2.pgv1", &assign_GovHydroIEEE2_pgv1);
	assign_map.emplace("cim:GovHydroIEEE2.pgv2", &assign_GovHydroIEEE2_pgv2);
	assign_map.emplace("cim:GovHydroIEEE2.pgv3", &assign_GovHydroIEEE2_pgv3);
	assign_map.emplace("cim:GovHydroIEEE2.pgv4", &assign_GovHydroIEEE2_pgv4);
	assign_map.emplace("cim:GovHydroIEEE2.pgv5", &assign_GovHydroIEEE2_pgv5);
	assign_map.emplace("cim:GovHydroIEEE2.pgv6", &assign_GovHydroIEEE2_pgv6);
	assign_map.emplace("cim:GovHydroIEEE2.pmax", &assign_GovHydroIEEE2_pmax);
	assign_map.emplace("cim:GovHydroIEEE2.pmin", &assign_GovHydroIEEE2_pmin);
	assign_map.emplace("cim:GovHydroIEEE2.rperm", &assign_GovHydroIEEE2_rperm);
	assign_map.emplace("cim:GovHydroIEEE2.rtemp", &assign_GovHydroIEEE2_rtemp);
	assign_map.emplace("cim:GovHydroIEEE2.tg", &assign_GovHydroIEEE2_tg);
	assign_map.emplace("cim:GovHydroIEEE2.tp", &assign_GovHydroIEEE2_tp);
	assign_map.emplace("cim:GovHydroIEEE2.tr", &assign_GovHydroIEEE2_tr);
	assign_map.emplace("cim:GovHydroIEEE2.tw", &assign_GovHydroIEEE2_tw);
	assign_map.emplace("cim:GovHydroIEEE2.uc", &assign_GovHydroIEEE2_uc);
	assign_map.emplace("cim:GovHydroIEEE2.uo", &assign_GovHydroIEEE2_uo);
}
