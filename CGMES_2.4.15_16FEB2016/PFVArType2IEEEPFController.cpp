...
{
	factory_map.emplace("cim:PFVArType2IEEEPFController", &PFVArType2IEEEPFController_factory);
}

void PFVArType2IEEEPFController::addPrimitiveAssignFnsToMap(std::unordered_map<std::string, assign_function>& assign_map)
{
	assign_map.emplace("cim:PFVArType2IEEEPFController.exlon", &assign_PFVArType2IEEEPFController_exlon);
	assign_map.emplace("cim:PFVArType2IEEEPFController.ki", &assign_PFVArType2IEEEPFController_ki);
	assign_map.emplace("cim:PFVArType2IEEEPFController.kp", &assign_PFVArType2IEEEPFController_kp);
	assign_map.emplace("cim:PFVArType2IEEEPFController.pfref", &assign_PFVArType2IEEEPFController_pfref);
	assign_map.emplace("cim:PFVArType2IEEEPFController.vclmt", &assign_PFVArType2IEEEPFController_vclmt);
	assign_map.emplace("cim:PFVArType2IEEEPFController.vref", &assign_PFVArType2IEEEPFController_vref);
	assign_map.emplace("cim:PFVArType2IEEEPFController.vs", &assign_PFVArType2IEEEPFController_vs);
}
