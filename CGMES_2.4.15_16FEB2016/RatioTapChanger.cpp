...
static const std::map<std::string, AttrDetails>& getClassAttrDetailsMap()
{
	...
	{
		{ "RatioTapChanger.RatioTapChangerTable", { "http://iec.ch/TC57/2013/CIM-schema-cim16#", { CGMESProfile::EQ, } } },
		{ "RatioTapChanger.TransformerEnd", { "http://iec.ch/TC57/2013/CIM-schema-cim16#", { CGMESProfile::EQ, } } },
		{ "RatioTapChanger.stepVoltageIncrement", { "http://iec.ch/TC57/2013/CIM-schema-cim16#", { CGMESProfile::EQ, } } },
		{ "RatioTapChanger.tculControlMode", { "http://iec.ch/TC57/2013/CIM-schema-cim16#", { CGMESProfile::EQ, } } },
	};
...
bool get_RatioTapChanger_tculControlMode(const BaseClass* BaseClass_ptr1, std::stringstream& buffer)
{
	const RatioTapChanger* element = dynamic_cast<const RatioTapChanger*>(BaseClass_ptr1);
	if (element != nullptr)
	{
...
void RatioTapChanger::addPrimitiveAssignFnsToMap(std::unordered_map<std::string, assign_function>& assign_map)
{
	...
	assign_map.emplace("RatioTapChanger.tculControlMode", &assign_RatioTapChanger_tculControlMode);
}
...
void RatioTapChanger::addEnumGetFnsToMap(std::map<std::string, get_function>& get_map) const
{
	...
	get_map.emplace("RatioTapChanger.tculControlMode", &get_RatioTapChanger_tculControlMode);
}
