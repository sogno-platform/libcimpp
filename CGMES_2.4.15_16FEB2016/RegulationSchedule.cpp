...
{
	factory_map.emplace("cim:RegulationSchedule", &RegulationSchedule_factory);
}
...
{
	assign_map.emplace("cim:RegulationSchedule.RegulatingControl", &assign_RegulationSchedule_RegulatingControl);
}
