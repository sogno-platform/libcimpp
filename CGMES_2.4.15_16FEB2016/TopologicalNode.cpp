...
TopologicalNode::TopologicalNode(): BaseVoltage(nullptr), ConnectivityNodeContainer(nullptr), SvInjection(nullptr), SvVoltage(nullptr), AngleRefTopologicalIsland(nullptr), TopologicalIsland(nullptr), ReportingGroup(nullptr) {};
