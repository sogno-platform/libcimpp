...
void WindContPType3IEC::addPrimitiveAssignFnsToMap(std::unordered_map<std::string, assign_function>& assign_map)
{
	...
	assign_map.emplace("cim:WindContPType3IEC.dtrisemaxlvrt", &assign_WindContPType3IEC_dtrisemaxlvrt);
	...
	assign_map.emplace("cim:WindContPType3IEC.mplvrt", &assign_WindContPType3IEC_mplvrt);
	...
	assign_map.emplace("cim:WindContPType3IEC.rramp", &assign_WindContPType3IEC_rramp);
	assign_map.emplace("cim:WindContPType3IEC.tdvs", &assign_WindContPType3IEC_tdvs);
	assign_map.emplace("cim:WindContPType3IEC.temin", &assign_WindContPType3IEC_temin);
	assign_map.emplace("cim:WindContPType3IEC.tomegafilt", &assign_WindContPType3IEC_tomegafilt);
	assign_map.emplace("cim:WindContPType3IEC.tpfilt", &assign_WindContPType3IEC_tpfilt);
	assign_map.emplace("cim:WindContPType3IEC.tpord", &assign_WindContPType3IEC_tpord);
	assign_map.emplace("cim:WindContPType3IEC.tufilt", &assign_WindContPType3IEC_tufilt);
	assign_map.emplace("cim:WindContPType3IEC.tuscale", &assign_WindContPType3IEC_tuscale);
	assign_map.emplace("cim:WindContPType3IEC.twref", &assign_WindContPType3IEC_twref);
	...
	assign_map.emplace("cim:WindContPType3IEC.wdtd", &assign_WindContPType3IEC_wdtd);
...
void WindContPType3IEC::addClassAssignFnsToMap(std::unordered_map<std::string, class_assign_function>& assign_map)
{
	...
	assign_map.emplace("cim:WindContPType3IEC.WindGenTurbineType3IEC", &assign_WindContPType3IEC_WindGenTurbineType3IEC);
}
