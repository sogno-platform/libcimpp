#ifndef DynamicsVersion_H
#define DynamicsVersion_H
/*
...
namespace CIMPP
{
	...
	class DynamicsVersion : public BaseClass
	{
	public:
		/* constructor initialising all attributes to null */
		DynamicsVersion();
		~DynamicsVersion() override;
		...
		/** \brief Profile URI defined by ENTSO-E and used in the Model Exchange header.  It uniquely identifies the Profile and its version. The last two elements in the URI (http://entsoe.eu/CIM/Dynamics/yy/zzz) indicate major and minor versions where:  - yy - indicates a major version; - zzz - indicates a minor version. Default: '' */
