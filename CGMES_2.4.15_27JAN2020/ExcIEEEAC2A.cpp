...
{
	factory_map.emplace("cim:ExcIEEEAC2A", &ExcIEEEAC2A_factory);
}

void ExcIEEEAC2A::addPrimitiveAssignFnsToMap(std::unordered_map<std::string, assign_function>& assign_map)
{
	assign_map.emplace("cim:ExcIEEEAC2A.ka", &assign_ExcIEEEAC2A_ka);
	assign_map.emplace("cim:ExcIEEEAC2A.kb", &assign_ExcIEEEAC2A_kb);
	assign_map.emplace("cim:ExcIEEEAC2A.kc", &assign_ExcIEEEAC2A_kc);
	assign_map.emplace("cim:ExcIEEEAC2A.kd", &assign_ExcIEEEAC2A_kd);
	assign_map.emplace("cim:ExcIEEEAC2A.ke", &assign_ExcIEEEAC2A_ke);
	assign_map.emplace("cim:ExcIEEEAC2A.kf", &assign_ExcIEEEAC2A_kf);
	assign_map.emplace("cim:ExcIEEEAC2A.kh", &assign_ExcIEEEAC2A_kh);
	assign_map.emplace("cim:ExcIEEEAC2A.seve1", &assign_ExcIEEEAC2A_seve1);
	assign_map.emplace("cim:ExcIEEEAC2A.seve2", &assign_ExcIEEEAC2A_seve2);
	assign_map.emplace("cim:ExcIEEEAC2A.ta", &assign_ExcIEEEAC2A_ta);
	assign_map.emplace("cim:ExcIEEEAC2A.tb", &assign_ExcIEEEAC2A_tb);
	assign_map.emplace("cim:ExcIEEEAC2A.tc", &assign_ExcIEEEAC2A_tc);
	assign_map.emplace("cim:ExcIEEEAC2A.te", &assign_ExcIEEEAC2A_te);
	assign_map.emplace("cim:ExcIEEEAC2A.tf", &assign_ExcIEEEAC2A_tf);
	assign_map.emplace("cim:ExcIEEEAC2A.vamax", &assign_ExcIEEEAC2A_vamax);
	assign_map.emplace("cim:ExcIEEEAC2A.vamin", &assign_ExcIEEEAC2A_vamin);
	assign_map.emplace("cim:ExcIEEEAC2A.ve1", &assign_ExcIEEEAC2A_ve1);
	assign_map.emplace("cim:ExcIEEEAC2A.ve2", &assign_ExcIEEEAC2A_ve2);
	assign_map.emplace("cim:ExcIEEEAC2A.vfemax", &assign_ExcIEEEAC2A_vfemax);
	assign_map.emplace("cim:ExcIEEEAC2A.vrmax", &assign_ExcIEEEAC2A_vrmax);
	assign_map.emplace("cim:ExcIEEEAC2A.vrmin", &assign_ExcIEEEAC2A_vrmin);
}
