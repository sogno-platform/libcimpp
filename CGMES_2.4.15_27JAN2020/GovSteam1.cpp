...
{
	factory_map.emplace("cim:GovSteam1", &GovSteam1_factory);
}

void GovSteam1::addPrimitiveAssignFnsToMap(std::unordered_map<std::string, assign_function>& assign_map)
{
	assign_map.emplace("cim:GovSteam1.db1", &assign_GovSteam1_db1);
	assign_map.emplace("cim:GovSteam1.db2", &assign_GovSteam1_db2);
	assign_map.emplace("cim:GovSteam1.eps", &assign_GovSteam1_eps);
	assign_map.emplace("cim:GovSteam1.gv1", &assign_GovSteam1_gv1);
	assign_map.emplace("cim:GovSteam1.gv2", &assign_GovSteam1_gv2);
	assign_map.emplace("cim:GovSteam1.gv3", &assign_GovSteam1_gv3);
	assign_map.emplace("cim:GovSteam1.gv4", &assign_GovSteam1_gv4);
	assign_map.emplace("cim:GovSteam1.gv5", &assign_GovSteam1_gv5);
	assign_map.emplace("cim:GovSteam1.gv6", &assign_GovSteam1_gv6);
	assign_map.emplace("cim:GovSteam1.k", &assign_GovSteam1_k);
	assign_map.emplace("cim:GovSteam1.k1", &assign_GovSteam1_k1);
	assign_map.emplace("cim:GovSteam1.k2", &assign_GovSteam1_k2);
	assign_map.emplace("cim:GovSteam1.k3", &assign_GovSteam1_k3);
	assign_map.emplace("cim:GovSteam1.k4", &assign_GovSteam1_k4);
	assign_map.emplace("cim:GovSteam1.k5", &assign_GovSteam1_k5);
	assign_map.emplace("cim:GovSteam1.k6", &assign_GovSteam1_k6);
	assign_map.emplace("cim:GovSteam1.k7", &assign_GovSteam1_k7);
	assign_map.emplace("cim:GovSteam1.k8", &assign_GovSteam1_k8);
	assign_map.emplace("cim:GovSteam1.mwbase", &assign_GovSteam1_mwbase);
	assign_map.emplace("cim:GovSteam1.pgv1", &assign_GovSteam1_pgv1);
	assign_map.emplace("cim:GovSteam1.pgv2", &assign_GovSteam1_pgv2);
	assign_map.emplace("cim:GovSteam1.pgv3", &assign_GovSteam1_pgv3);
	assign_map.emplace("cim:GovSteam1.pgv4", &assign_GovSteam1_pgv4);
	assign_map.emplace("cim:GovSteam1.pgv5", &assign_GovSteam1_pgv5);
	assign_map.emplace("cim:GovSteam1.pgv6", &assign_GovSteam1_pgv6);
	assign_map.emplace("cim:GovSteam1.pmax", &assign_GovSteam1_pmax);
	assign_map.emplace("cim:GovSteam1.pmin", &assign_GovSteam1_pmin);
	assign_map.emplace("cim:GovSteam1.sdb1", &assign_GovSteam1_sdb1);
	assign_map.emplace("cim:GovSteam1.sdb2", &assign_GovSteam1_sdb2);
	assign_map.emplace("cim:GovSteam1.t1", &assign_GovSteam1_t1);
	assign_map.emplace("cim:GovSteam1.t2", &assign_GovSteam1_t2);
	assign_map.emplace("cim:GovSteam1.t3", &assign_GovSteam1_t3);
	assign_map.emplace("cim:GovSteam1.t4", &assign_GovSteam1_t4);
	assign_map.emplace("cim:GovSteam1.t5", &assign_GovSteam1_t5);
	assign_map.emplace("cim:GovSteam1.t6", &assign_GovSteam1_t6);
	assign_map.emplace("cim:GovSteam1.t7", &assign_GovSteam1_t7);
	assign_map.emplace("cim:GovSteam1.uc", &assign_GovSteam1_uc);
	assign_map.emplace("cim:GovSteam1.uo", &assign_GovSteam1_uo);
	assign_map.emplace("cim:GovSteam1.valve", &assign_GovSteam1_valve);
}
