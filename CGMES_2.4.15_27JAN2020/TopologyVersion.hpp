#ifndef TopologyVersion_H
#define TopologyVersion_H
/*
...
namespace CIMPP
{
	...
	class TopologyVersion : public BaseClass
	{
	public:
		/* constructor initialising all attributes to null */
		TopologyVersion();
		~TopologyVersion() override;
		...
		/** \brief Profile URI defined by ENTSO-E and used in the Model Exchange header.  It uniquely identifies the Profile and its version. The last two elements in the URI (http://entsoe.eu/CIM/Topology/yy/zzz) indicate major and minor versions where:  - yy - indicates a major version; - zzz - indicates a minor version. Default: '' */
