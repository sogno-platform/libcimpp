...
static const std::map<std::string, AttrDetails>& getClassAttrDetailsMap()
{
	...
	{
		{ "ACDCConverter.DCTerminals", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "ACDCConverter.PccTerminal", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "ACDCConverter.baseS", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "ACDCConverter.idc", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::SV, } } },
		{ "ACDCConverter.idleLoss", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "ACDCConverter.maxP", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "ACDCConverter.maxUdc", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "ACDCConverter.minP", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "ACDCConverter.minUdc", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "ACDCConverter.numberOfValves", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "ACDCConverter.p", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::SSH, } } },
		{ "ACDCConverter.poleLossP", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::SV, } } },
		{ "ACDCConverter.q", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::SSH, } } },
		{ "ACDCConverter.ratedUdc", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "ACDCConverter.resistiveLoss", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "ACDCConverter.switchingLoss", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "ACDCConverter.targetPpcc", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::SSH, } } },
		{ "ACDCConverter.targetUdc", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::SSH, } } },
		{ "ACDCConverter.uc", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::SV, } } },
...
void ACDCConverter::addPrimitiveAssignFnsToMap(std::unordered_map<std::string, assign_function>& assign_map)
{
	...
	assign_map.emplace("ACDCConverter.maxP", &assign_ACDCConverter_maxP);
	assign_map.emplace("ACDCConverter.maxUdc", &assign_ACDCConverter_maxUdc);
	assign_map.emplace("ACDCConverter.minP", &assign_ACDCConverter_minP);
...
void ACDCConverter::addPrimitiveGetFnsToMap(std::map<std::string, get_function>& get_map) const
{
	...
	get_map.emplace("ACDCConverter.maxP", &get_ACDCConverter_maxP);
	get_map.emplace("ACDCConverter.maxUdc", &get_ACDCConverter_maxUdc);
	get_map.emplace("ACDCConverter.minP", &get_ACDCConverter_minP);
