...
static const std::map<std::string, AttrDetails>& getClassAttrDetailsMap()
{
	...
	{
		{ "ActivePowerLimit.normalValue", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "ActivePowerLimit.value", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::SSH, } } },
	};
...
{
	assign_map.emplace("ActivePowerLimit.normalValue", &assign_ActivePowerLimit_normalValue);
...
void ActivePowerLimit::addPrimitiveGetFnsToMap(std::map<std::string, get_function>& get_map) const
{
	...
	get_map.emplace("ActivePowerLimit.normalValue", &get_ActivePowerLimit_normalValue);
