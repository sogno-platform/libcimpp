...
namespace CIMPP
{
	...
	*/
	...
	public:
		...
		std::list<CIMPP::AnalogValue*> AnalogValues;  /* The values connected to this measurement. Default: 0 */
		std::list<CIMPP::AnalogLimitSet*> LimitSets;  /* A measurement may have zero or more limit ranges defined for it. Default: 0 */
