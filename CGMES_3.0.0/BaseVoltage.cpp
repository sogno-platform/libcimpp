...
static const std::map<std::string, AttrDetails>& getClassAttrDetailsMap()
{
	...
	{
		{ "BaseVoltage.ConductingEquipment", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "BaseVoltage.TopologicalNode", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::TP, } } },
		{ "BaseVoltage.TransformerEnds", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "BaseVoltage.VoltageLevel", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, CGMESProfile::EQBD, } } },
		{ "BaseVoltage.nominalVoltage", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, CGMESProfile::EQBD, } } },
	};
