#ifndef CSCUserDefined_H
#define CSCUserDefined_H
/*
...
namespace CIMPP
{
	...
	/** \brief Current source converter (CSC) function block whose dynamic behaviour is described by <font color="#0f0f0f">a user-defined model.</font> */
	class CSCUserDefined : public CSCDynamics
	{
	public:
		/* constructor initialising all attributes to null */
		CSCUserDefined();
		~CSCUserDefined() override;
