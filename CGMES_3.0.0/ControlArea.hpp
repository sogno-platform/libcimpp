...
namespace CIMPP
{
	...
	*/
	...
	public:
		...
		std::list<CIMPP::ControlAreaGeneratingUnit*> ControlAreaGeneratingUnit;  /* The generating unit specifications for the control area. Default: 0 */
		...
		CIMPP::ActivePower netInterchange;  /* The specified positive net interchange into the control area, i.e. positive sign means flow into the area. Default: nullptr */
		CIMPP::ActivePower pTolerance;  /* Active power net interchange tolerance. The attribute shall be a positive value or zero. Default: nullptr */
