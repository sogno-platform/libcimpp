...
bool assign_CsConverter_CSCDynamics(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	...
	CSCDynamics* element2 = dynamic_cast<CSCDynamics*>(BaseClass_ptr2);
	if (element != nullptr && element2 != nullptr)
	{
		if (element->CSCDynamics != element2)
		{
			element->CSCDynamics = element2;
			return assign_CSCDynamics_CSConverter(BaseClass_ptr2, BaseClass_ptr1);
		}
		return true;
	}
	return false;
