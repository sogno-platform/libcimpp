...
static const std::map<std::string, AttrDetails>& getClassAttrDetailsMap()
{
	...
	{
		{ "DCConductingEquipment.DCTerminals", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "DCConductingEquipment.ratedUdc", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
	};
...
{
	assign_map.emplace("DCConductingEquipment.ratedUdc", &assign_DCConductingEquipment_ratedUdc);
}
...
void DCConductingEquipment::addPrimitiveGetFnsToMap(std::map<std::string, get_function>& get_map) const
{
	...
	get_map.emplace("DCConductingEquipment.ratedUdc", &get_DCConductingEquipment_ratedUdc);
}
