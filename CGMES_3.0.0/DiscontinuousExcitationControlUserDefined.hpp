...
namespace CIMPP
{
	...
	/** \brief Discontinuous excitation control function block whose dynamic behaviour is described by <font color="#0f0f0f">a user-defined model.</font> */
	class DiscontinuousExcitationControlUserDefined : public DiscontinuousExcitationControlDynamics
	{
	public:
		/* constructor initialising all attributes to null */
		DiscontinuousExcitationControlUserDefined();
		~DiscontinuousExcitationControlUserDefined() override;
