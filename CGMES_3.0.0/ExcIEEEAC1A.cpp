...
{
	factory_map.emplace("cim:ExcIEEEAC1A", &ExcIEEEAC1A_factory);
}

void ExcIEEEAC1A::addPrimitiveAssignFnsToMap(std::unordered_map<std::string, assign_function>& assign_map)
{
	assign_map.emplace("cim:ExcIEEEAC1A.ka", &assign_ExcIEEEAC1A_ka);
	assign_map.emplace("cim:ExcIEEEAC1A.kc", &assign_ExcIEEEAC1A_kc);
	assign_map.emplace("cim:ExcIEEEAC1A.kd", &assign_ExcIEEEAC1A_kd);
	assign_map.emplace("cim:ExcIEEEAC1A.ke", &assign_ExcIEEEAC1A_ke);
	assign_map.emplace("cim:ExcIEEEAC1A.kf", &assign_ExcIEEEAC1A_kf);
	assign_map.emplace("cim:ExcIEEEAC1A.seve1", &assign_ExcIEEEAC1A_seve1);
	assign_map.emplace("cim:ExcIEEEAC1A.seve2", &assign_ExcIEEEAC1A_seve2);
	assign_map.emplace("cim:ExcIEEEAC1A.ta", &assign_ExcIEEEAC1A_ta);
	assign_map.emplace("cim:ExcIEEEAC1A.tb", &assign_ExcIEEEAC1A_tb);
	assign_map.emplace("cim:ExcIEEEAC1A.tc", &assign_ExcIEEEAC1A_tc);
	assign_map.emplace("cim:ExcIEEEAC1A.te", &assign_ExcIEEEAC1A_te);
	assign_map.emplace("cim:ExcIEEEAC1A.tf", &assign_ExcIEEEAC1A_tf);
	assign_map.emplace("cim:ExcIEEEAC1A.vamax", &assign_ExcIEEEAC1A_vamax);
	assign_map.emplace("cim:ExcIEEEAC1A.vamin", &assign_ExcIEEEAC1A_vamin);
	assign_map.emplace("cim:ExcIEEEAC1A.ve1", &assign_ExcIEEEAC1A_ve1);
	assign_map.emplace("cim:ExcIEEEAC1A.ve2", &assign_ExcIEEEAC1A_ve2);
	assign_map.emplace("cim:ExcIEEEAC1A.vrmax", &assign_ExcIEEEAC1A_vrmax);
	assign_map.emplace("cim:ExcIEEEAC1A.vrmin", &assign_ExcIEEEAC1A_vrmin);
}
