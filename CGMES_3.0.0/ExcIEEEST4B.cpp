...
{
	factory_map.emplace("cim:ExcIEEEST4B", &ExcIEEEST4B_factory);
}

void ExcIEEEST4B::addPrimitiveAssignFnsToMap(std::unordered_map<std::string, assign_function>& assign_map)
{
	assign_map.emplace("cim:ExcIEEEST4B.kc", &assign_ExcIEEEST4B_kc);
	assign_map.emplace("cim:ExcIEEEST4B.kg", &assign_ExcIEEEST4B_kg);
	assign_map.emplace("cim:ExcIEEEST4B.ki", &assign_ExcIEEEST4B_ki);
	assign_map.emplace("cim:ExcIEEEST4B.kim", &assign_ExcIEEEST4B_kim);
	assign_map.emplace("cim:ExcIEEEST4B.kir", &assign_ExcIEEEST4B_kir);
	assign_map.emplace("cim:ExcIEEEST4B.kp", &assign_ExcIEEEST4B_kp);
	assign_map.emplace("cim:ExcIEEEST4B.kpm", &assign_ExcIEEEST4B_kpm);
	assign_map.emplace("cim:ExcIEEEST4B.kpr", &assign_ExcIEEEST4B_kpr);
	assign_map.emplace("cim:ExcIEEEST4B.ta", &assign_ExcIEEEST4B_ta);
	assign_map.emplace("cim:ExcIEEEST4B.thetap", &assign_ExcIEEEST4B_thetap);
	assign_map.emplace("cim:ExcIEEEST4B.vbmax", &assign_ExcIEEEST4B_vbmax);
	assign_map.emplace("cim:ExcIEEEST4B.vmmax", &assign_ExcIEEEST4B_vmmax);
	assign_map.emplace("cim:ExcIEEEST4B.vmmin", &assign_ExcIEEEST4B_vmmin);
	assign_map.emplace("cim:ExcIEEEST4B.vrmax", &assign_ExcIEEEST4B_vrmax);
	assign_map.emplace("cim:ExcIEEEST4B.vrmin", &assign_ExcIEEEST4B_vrmin);
	assign_map.emplace("cim:ExcIEEEST4B.xl", &assign_ExcIEEEST4B_xl);
}
