...
{
	factory_map.emplace("cim:ExcST2A", &ExcST2A_factory);
}

void ExcST2A::addPrimitiveAssignFnsToMap(std::unordered_map<std::string, assign_function>& assign_map)
{
	assign_map.emplace("cim:ExcST2A.efdmax", &assign_ExcST2A_efdmax);
	assign_map.emplace("cim:ExcST2A.ka", &assign_ExcST2A_ka);
	assign_map.emplace("cim:ExcST2A.kc", &assign_ExcST2A_kc);
	assign_map.emplace("cim:ExcST2A.ke", &assign_ExcST2A_ke);
	assign_map.emplace("cim:ExcST2A.kf", &assign_ExcST2A_kf);
	assign_map.emplace("cim:ExcST2A.ki", &assign_ExcST2A_ki);
	assign_map.emplace("cim:ExcST2A.kp", &assign_ExcST2A_kp);
	assign_map.emplace("cim:ExcST2A.ta", &assign_ExcST2A_ta);
	assign_map.emplace("cim:ExcST2A.tb", &assign_ExcST2A_tb);
	assign_map.emplace("cim:ExcST2A.tc", &assign_ExcST2A_tc);
	assign_map.emplace("cim:ExcST2A.te", &assign_ExcST2A_te);
	assign_map.emplace("cim:ExcST2A.tf", &assign_ExcST2A_tf);
	assign_map.emplace("cim:ExcST2A.uelin", &assign_ExcST2A_uelin);
	assign_map.emplace("cim:ExcST2A.vrmax", &assign_ExcST2A_vrmax);
	assign_map.emplace("cim:ExcST2A.vrmin", &assign_ExcST2A_vrmin);
}
