...
namespace CIMPP
{
	...
	/** \brief Excitation system function block whose dynamic behaviour is described by <font color="#0f0f0f">a user-defined model.</font> */
	class ExcitationSystemUserDefined : public ExcitationSystemDynamics
	{
	public:
		/* constructor initialising all attributes to null */
		ExcitationSystemUserDefined();
		~ExcitationSystemUserDefined() override;
