...
static const std::map<std::string, AttrDetails>& getClassAttrDetailsMap()
{
	...
	{
		{ "GeneratingUnit.ControlAreaGeneratingUnit", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "GeneratingUnit.GrossToNetActivePowerCurves", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "GeneratingUnit.RotatingMachine", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "GeneratingUnit.genControlSource", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "GeneratingUnit.governorSCD", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "GeneratingUnit.longPF", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "GeneratingUnit.maxOperatingP", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "GeneratingUnit.maximumAllowableSpinningReserve", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "GeneratingUnit.minOperatingP", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "GeneratingUnit.nominalP", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "GeneratingUnit.normalPF", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::SSH, } } },
		{ "GeneratingUnit.ratedGrossMaxP", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "GeneratingUnit.ratedGrossMinP", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "GeneratingUnit.ratedNetMaxP", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "GeneratingUnit.shortPF", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "GeneratingUnit.startupCost", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "GeneratingUnit.startupTime", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
...
void GeneratingUnit::addPrimitiveAssignFnsToMap(std::unordered_map<std::string, assign_function>& assign_map)
{
	...
	assign_map.emplace("GeneratingUnit.startupTime", &assign_GeneratingUnit_startupTime);
...
void GeneratingUnit::addPrimitiveGetFnsToMap(std::map<std::string, get_function>& get_map) const
{
	...
	get_map.emplace("GeneratingUnit.startupTime", &get_GeneratingUnit_startupTime);
