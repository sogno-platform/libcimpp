...
namespace CIMPP
{
	...
	*/
	...
	public:
		...
		CIMPP::Float aset;  /* Acceleration limiter setpoint (&lt;i&gt;Aset&lt;/i&gt;).  Unit = PU / s.  Typical value = 0,01. Default: 0.0 */
		...
		CIMPP::PU kigov;  /* Governor integral gain (&lt;i&gt;Kigov&lt;/i&gt;).  Typical value = 2. Default: nullptr */
		CIMPP::PU kiload;  /* Load limiter integral gain for PI controller (&lt;i&gt;Kiload&lt;/i&gt;).  Typical value = 0,67. Default: nullptr */
		CIMPP::PU kimw;  /* Power controller (reset) gain (&lt;i&gt;Kimw&lt;/i&gt;).  The default value of 0,01 corresponds to a reset time of 100 s.  A value of 0,001 corresponds to a relatively slow-acting load controller.  Typical value = 0,01. Default: nullptr */
		CIMPP::PU kpgov;  /* Governor proportional gain (&lt;i&gt;Kpgov&lt;/i&gt;).  Typical value = 10. Default: nullptr */
		CIMPP::PU kpload;  /* Load limiter proportional gain for PI controller (&lt;i&gt;Kpload&lt;/i&gt;).  Typical value = 2. Default: nullptr */
		CIMPP::PU kturb;  /* Turbine gain (&lt;i&gt;Kturb&lt;/i&gt;) (&amp;gt; 0).  Typical value = 1,5. Default: nullptr */
		CIMPP::PU ldref;  /* Load limiter reference value (&lt;i&gt;Ldref&lt;/i&gt;).  Typical value = 1. Default: nullptr */
		CIMPP::PU maxerr;  /* Maximum value for speed error signal (&lt;i&gt;maxerr&lt;/i&gt;) (&amp;gt; GovCT1.minerr).  Typical value = 0,05. Default: nullptr */
		CIMPP::PU minerr;  /* Minimum value for speed error signal (&lt;i&gt;minerr&lt;/i&gt;) (&amp;lt; GovCT1.maxerr).  Typical value = -0,05. Default: nullptr */
		CIMPP::ActivePower mwbase;  /* Base for power values (&lt;i&gt;MWbase&lt;/i&gt;) (&amp;gt; 0).  Unit = MW. Default: nullptr */
		CIMPP::PU r;  /* Permanent droop (&lt;i&gt;R&lt;/i&gt;).  Typical value = 0,04. Default: nullptr */
		CIMPP::Float rclose;  /* Minimum valve closing rate (&lt;i&gt;Rclose&lt;/i&gt;).  Unit = PU / s.  Typical value = -0,1. Default: 0.0 */
		CIMPP::PU rdown;  /* Maximum rate of load limit decrease (&lt;i&gt;Rdown&lt;/i&gt;).  Typical value = -99. Default: nullptr */
		CIMPP::Float ropen;  /* Maximum valve opening rate (&lt;i&gt;Ropen&lt;/i&gt;).  Unit = PU / s.  Typical value = 0.10. Default: 0.0 */
		...
		CIMPP::Seconds ta;  /* Acceleration limiter time constant (&lt;i&gt;Ta&lt;/i&gt;) (&amp;gt; 0).  Typical value = 0,1. Default: nullptr */
		CIMPP::Seconds tact;  /* Actuator time constant (&lt;i&gt;Tact&lt;/i&gt;) (&amp;gt;= 0).  Typical value = 0,5. Default: nullptr */
		CIMPP::Seconds tb;  /* Turbine lag time constant (&lt;i&gt;Tb&lt;/i&gt;) (&amp;gt; 0).  Typical value = 0,5. Default: nullptr */
		...
		CIMPP::Seconds tpelec;  /* Electrical power transducer time constant (&lt;i&gt;Tpelec&lt;/i&gt;) (&amp;gt; 0).  Typical value = 1. Default: nullptr */
		CIMPP::Seconds tsa;  /* Temperature detection lead time constant (&lt;i&gt;Tsa&lt;/i&gt;) (&amp;gt;= 0).  Typical value = 4. Default: nullptr */
		CIMPP::Seconds tsb;  /* Temperature detection lag time constant (&lt;i&gt;Tsb&lt;/i&gt;) (&amp;gt;= 0).  Typical value = 5. Default: nullptr */
		CIMPP::PU vmax;  /* Maximum valve position limit (&lt;i&gt;Vmax&lt;/i&gt;) (&amp;gt; GovCT1.vmin).  Typical value = 1. Default: nullptr */
		CIMPP::PU vmin;  /* Minimum valve position limit (&lt;i&gt;Vmin&lt;/i&gt;) (&amp;lt; GovCT1.vmax).  Typical value = 0,15. Default: nullptr */
		CIMPP::PU wfnl;  /* No load fuel flow (&lt;i&gt;Wfnl&lt;/i&gt;).  Typical value = 0,2. Default: nullptr */
