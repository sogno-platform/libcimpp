...
namespace CIMPP
{
	...
	*/
	...
	public:
		...
		CIMPP::Float a;  /* Turbine power time constant numerator scale factor (&lt;i&gt;a&lt;/i&gt;).  Typical value = 0,8. Default: 0.0 */
		CIMPP::Float b;  /* Turbine power time constant denominator scale factor (&lt;i&gt;b&lt;/i&gt;) (&amp;gt;0).  Typical value = 1. Default: 0.0 */
		...
		CIMPP::PU fidle;  /* Fuel flow at zero power output (&lt;i&gt;Fidle&lt;/i&gt;).  Typical value = 0,18. Default: nullptr */
		...
		CIMPP::PU ka;  /* Governor gain (&lt;i&gt;Ka&lt;/i&gt;).  Typical value = 0. Default: nullptr */
		CIMPP::PU kt;  /* Temperature limiter gain (&lt;i&gt;Kt&lt;/i&gt;).  Typical value = 3. Default: nullptr */
		CIMPP::PU lmax;  /* Ambient temperature load limit (&lt;i&gt;Lmax&lt;/i&gt;).  &lt;i&gt;Lmax&lt;/i&gt; is the turbine power output corresponding to the limiting exhaust gas temperature.  Typical value = 1. Default: nullptr */
		CIMPP::PU loadinc;  /* Valve position change allowed at fast rate (&lt;i&gt;Loadinc&lt;/i&gt;).  Typical value = 0,05. Default: nullptr */
		CIMPP::Float ltrate;  /* Maximum long term fuel valve opening rate (&lt;i&gt;Ltrate&lt;/i&gt;).  Typical value = 0,02. Default: 0.0 */
		...
		CIMPP::Float rmax;  /* Maximum fuel valve opening rate (&lt;i&gt;Rmax&lt;/i&gt;).  Unit = PU / s.  Typical value = 1. Default: 0.0 */
		...
		CIMPP::Seconds t3;  /* Turbine exhaust temperature time constant (&lt;i&gt;T3&lt;/i&gt;) (&amp;gt;= 0).  &lt;i&gt;T3&lt;/i&gt; represents delay in the exhaust temperature and load limiting system. Typical value = 3. Default: nullptr */
		CIMPP::Seconds t4;  /* Governor lead time constant (&lt;i&gt;T4&lt;/i&gt;) (&amp;gt;= 0).  Typical value = 0. Default: nullptr */
		CIMPP::Seconds t5;  /* Governor lag time constant (&lt;i&gt;T5&lt;/i&gt;) (&amp;gt;= 0).  If = 0, entire gain and lead-lag block is bypassed.  Typical value = 0. Default: nullptr */
		CIMPP::Seconds tltr;  /* Valve position averaging time constant (&lt;i&gt;Tltr&lt;/i&gt;) (&amp;gt;= 0).  Typical value = 10. Default: nullptr */
		CIMPP::PU vmax;  /* Maximum turbine power, PU of MWbase (&lt;i&gt;Vmax&lt;/i&gt;) (&amp;gt; GovGAST1.vmin).  Typical value = 1. Default: nullptr */
		CIMPP::PU vmin;  /* Minimum turbine power, PU of MWbase (&lt;i&gt;Vmin&lt;/i&gt;) (&amp;lt; GovGAST1.vmax).  Typical value = 0. Default: nullptr */
