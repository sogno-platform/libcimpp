...
{
	factory_map.emplace("cim:GovHydro3", &GovHydro3_factory);
}

void GovHydro3::addPrimitiveAssignFnsToMap(std::unordered_map<std::string, assign_function>& assign_map)
{
	assign_map.emplace("cim:GovHydro3.at", &assign_GovHydro3_at);
	assign_map.emplace("cim:GovHydro3.db1", &assign_GovHydro3_db1);
	assign_map.emplace("cim:GovHydro3.db2", &assign_GovHydro3_db2);
	assign_map.emplace("cim:GovHydro3.dturb", &assign_GovHydro3_dturb);
	assign_map.emplace("cim:GovHydro3.eps", &assign_GovHydro3_eps);
	assign_map.emplace("cim:GovHydro3.governorControl", &assign_GovHydro3_governorControl);
	assign_map.emplace("cim:GovHydro3.gv1", &assign_GovHydro3_gv1);
	assign_map.emplace("cim:GovHydro3.gv2", &assign_GovHydro3_gv2);
	assign_map.emplace("cim:GovHydro3.gv3", &assign_GovHydro3_gv3);
	assign_map.emplace("cim:GovHydro3.gv4", &assign_GovHydro3_gv4);
	assign_map.emplace("cim:GovHydro3.gv5", &assign_GovHydro3_gv5);
	assign_map.emplace("cim:GovHydro3.gv6", &assign_GovHydro3_gv6);
	assign_map.emplace("cim:GovHydro3.h0", &assign_GovHydro3_h0);
	assign_map.emplace("cim:GovHydro3.k1", &assign_GovHydro3_k1);
	assign_map.emplace("cim:GovHydro3.k2", &assign_GovHydro3_k2);
	assign_map.emplace("cim:GovHydro3.kg", &assign_GovHydro3_kg);
	assign_map.emplace("cim:GovHydro3.ki", &assign_GovHydro3_ki);
	assign_map.emplace("cim:GovHydro3.mwbase", &assign_GovHydro3_mwbase);
	assign_map.emplace("cim:GovHydro3.pgv1", &assign_GovHydro3_pgv1);
	assign_map.emplace("cim:GovHydro3.pgv2", &assign_GovHydro3_pgv2);
	assign_map.emplace("cim:GovHydro3.pgv3", &assign_GovHydro3_pgv3);
	assign_map.emplace("cim:GovHydro3.pgv4", &assign_GovHydro3_pgv4);
	assign_map.emplace("cim:GovHydro3.pgv5", &assign_GovHydro3_pgv5);
	assign_map.emplace("cim:GovHydro3.pgv6", &assign_GovHydro3_pgv6);
	assign_map.emplace("cim:GovHydro3.pmax", &assign_GovHydro3_pmax);
	assign_map.emplace("cim:GovHydro3.pmin", &assign_GovHydro3_pmin);
	assign_map.emplace("cim:GovHydro3.qnl", &assign_GovHydro3_qnl);
	assign_map.emplace("cim:GovHydro3.relec", &assign_GovHydro3_relec);
	assign_map.emplace("cim:GovHydro3.rgate", &assign_GovHydro3_rgate);
	assign_map.emplace("cim:GovHydro3.td", &assign_GovHydro3_td);
	assign_map.emplace("cim:GovHydro3.tf", &assign_GovHydro3_tf);
	assign_map.emplace("cim:GovHydro3.tp", &assign_GovHydro3_tp);
	assign_map.emplace("cim:GovHydro3.tt", &assign_GovHydro3_tt);
	assign_map.emplace("cim:GovHydro3.tw", &assign_GovHydro3_tw);
	assign_map.emplace("cim:GovHydro3.velcl", &assign_GovHydro3_velcl);
	assign_map.emplace("cim:GovHydro3.velop", &assign_GovHydro3_velop);
}
