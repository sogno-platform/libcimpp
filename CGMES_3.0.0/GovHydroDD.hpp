...
namespace CIMPP
{
	...
	*/
	...
	public:
		...
		CIMPP::PU aturb;  /* Turbine numerator multiplier (&lt;i&gt;Aturb&lt;/i&gt;) (see parameter detail 3).  Typical value = -1. Default: nullptr */
		CIMPP::PU bturb;  /* Turbine denominator multiplier (&lt;i&gt;Bturb&lt;/i&gt;) (see parameter detail 3).  Typical value = 0,5. Default: nullptr */
		...
		CIMPP::PU gmax;  /* Maximum gate opening (&lt;i&gt;Gmax&lt;/i&gt;) (&amp;gt; GovHydroDD.gmin).  Typical value = 0. Default: nullptr */
		CIMPP::PU gmin;  /* Minimum gate opening (&lt;i&gt;Gmin&lt;/i&gt;) (&amp;lt; GovHydroDD.gmax).  Typical value = 0. Default: nullptr */
		...
		CIMPP::PU k1;  /* Single derivative gain (&lt;i&gt;K1&lt;/i&gt;).  Typical value = 3,6. Default: nullptr */
		CIMPP::PU k2;  /* Double derivative gain (&lt;i&gt;K2&lt;/i&gt;).  Typical value = 0,2. Default: nullptr */
		CIMPP::PU kg;  /* Gate servo gain (&lt;i&gt;Kg&lt;/i&gt;).  Typical value = 3. Default: nullptr */
		CIMPP::PU ki;  /* Integral gain (&lt;i&gt;Ki&lt;/i&gt;).  Typical value = 1. Default: nullptr */
		...
		CIMPP::PU pmax;  /* Maximum gate opening, PU of &lt;i&gt;MWbase&lt;/i&gt; (&lt;i&gt;Pmax&lt;/i&gt;) (&amp;gt; GovHydroDD.pmin).  Typical value = 1. Default: nullptr */
		CIMPP::PU pmin;  /* Minimum gate opening, PU of &lt;i&gt;MWbase&lt;/i&gt; (&lt;i&gt;Pmin&lt;/i&gt;) (&amp;gt; GovHydroDD.pmax).  Typical value = 0. Default: nullptr */
		CIMPP::PU r;  /* Steady state droop (&lt;i&gt;R&lt;/i&gt;).  Typical value = 0,05. Default: nullptr */
		CIMPP::Seconds td;  /* Input filter time constant (&lt;i&gt;Td&lt;/i&gt;) (&amp;gt;= 0).  If = 0, block is bypassed.  Typical value = 0. Default: nullptr */
		CIMPP::Seconds tf;  /* Washout time constant (&lt;i&gt;Tf&lt;/i&gt;) (&amp;gt;= 0).  Typical value = 0,1. Default: nullptr */
		CIMPP::Seconds tp;  /* Gate servo time constant (&lt;i&gt;Tp&lt;/i&gt;) (&amp;gt;= 0).  If = 0, block is bypassed.  Typical value = 0,35. Default: nullptr */
		CIMPP::Seconds tt;  /* Power feedback time constant (&lt;i&gt;Tt&lt;/i&gt;) (&amp;gt;= 0).  If = 0, block is bypassed.  Typical value = 0,02. Default: nullptr */
		CIMPP::Seconds tturb;  /* Turbine time constant (&lt;i&gt;Tturb&lt;/i&gt;)  (&amp;gt;= 0).  See parameter detail 3.  Typical value = 0,8. Default: nullptr */
		CIMPP::Float velcl;  /* Maximum gate closing velocity (&lt;i&gt;Velcl&lt;/i&gt;).  Unit = PU / s.  Typical value = -0,14. Default: 0.0 */
		CIMPP::Float velop;  /* Maximum gate opening velocity (&lt;i&gt;Velop&lt;/i&gt;).  Unit = PU / s.  Typical value = 0,09. Default: 0.0 */
