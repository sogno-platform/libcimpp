...
namespace CIMPP
{
	...
	*/
	...
	public:
		...
		CIMPP::PU kg;  /* Gate servo gain (&lt;i&gt;Kg&lt;/i&gt;).  Typical value = 2,5. Default: nullptr */
		CIMPP::PU ki;  /* Integral gain (&lt;i&gt;Ki&lt;/i&gt;).  Typical value = 0,36. Default: nullptr */
		...
		CIMPP::PU pmax;  /* Maximum gate opening, PU of MWbase (&lt;i&gt;Pmax&lt;/i&gt;) (&amp;gt; GovHydroPID.pmin).  Typical value = 1. Default: nullptr */
		CIMPP::PU pmin;  /* Minimum gate opening, PU of MWbase (&lt;i&gt;Pmin&lt;/i&gt;) (&amp;lt; GovHydroPID.pmax).  Typical value = 0. Default: nullptr */
