...
{
	assign_map.insert(std::make_pair(std::string("cim:GovSteamFV3.gv1"), &assign_GovSteamFV3_gv1));
	assign_map.insert(std::make_pair(std::string("cim:GovSteamFV3.gv2"), &assign_GovSteamFV3_gv2));
	assign_map.insert(std::make_pair(std::string("cim:GovSteamFV3.gv3"), &assign_GovSteamFV3_gv3));
	assign_map.insert(std::make_pair(std::string("cim:GovSteamFV3.gv4"), &assign_GovSteamFV3_gv4));
	assign_map.insert(std::make_pair(std::string("cim:GovSteamFV3.gv5"), &assign_GovSteamFV3_gv5));
	assign_map.insert(std::make_pair(std::string("cim:GovSteamFV3.gv6"), &assign_GovSteamFV3_gv6));
	...
	assign_map.insert(std::make_pair(std::string("cim:GovSteamFV3.pgv1"), &assign_GovSteamFV3_pgv1));
	assign_map.insert(std::make_pair(std::string("cim:GovSteamFV3.pgv2"), &assign_GovSteamFV3_pgv2));
	assign_map.insert(std::make_pair(std::string("cim:GovSteamFV3.pgv3"), &assign_GovSteamFV3_pgv3));
	assign_map.insert(std::make_pair(std::string("cim:GovSteamFV3.pgv4"), &assign_GovSteamFV3_pgv4));
	assign_map.insert(std::make_pair(std::string("cim:GovSteamFV3.pgv5"), &assign_GovSteamFV3_pgv5));
	assign_map.insert(std::make_pair(std::string("cim:GovSteamFV3.pgv6"), &assign_GovSteamFV3_pgv6));
