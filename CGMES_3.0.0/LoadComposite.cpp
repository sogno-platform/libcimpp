...
static const std::map<std::string, std::list<CGMESProfile>> PossibleProfilesForAttributes =
{
	...
	{ "cim:LoadComposite.lfac", { CGMESProfile::DY, } },
...
void LoadComposite::addPrimitiveAssignFnsToMap(std::unordered_map<std::string, assign_function>& assign_map)
{
	...
	assign_map.insert(std::make_pair(std::string("cim:LoadComposite.lfac"), &assign_LoadComposite_lfac));
...
void LoadComposite::addPrimitiveGetFnsToMap(std::map<std::string, get_function>& get_map) const
{
	...
	get_map.emplace("cim:LoadComposite.lfac", &get_LoadComposite_lfac);
