...
namespace CIMPP
{
	...
	*/
	...
	public:
		...
		CIMPP::Float d;  /* Damping factor (&lt;i&gt;D&lt;/i&gt;).  Unit = delta &lt;i&gt;P&lt;/i&gt;/delta speed.  Typical value = 2. Default: 0.0 */
		CIMPP::Seconds h;  /* Inertia constant (&lt;i&gt;H&lt;/i&gt;) (&amp;gt;= 0).  Typical value = 0,4. Default: nullptr */
		CIMPP::Float lfac;  /* Loading factor (&lt;i&gt;Lfac&lt;/i&gt;). The ratio of initial &lt;i&gt;P&lt;/i&gt; to motor MVA base.  Typical value = 0,8. Default: 0.0 */
		CIMPP::PU lp;  /* Transient reactance (&lt;i&gt;Lp&lt;/i&gt;).  Typical value = 0,15. Default: nullptr */
		CIMPP::PU lpp;  /* Subtransient reactance (&lt;i&gt;Lpp&lt;/i&gt;).  Typical value = 0,15. Default: nullptr */
		CIMPP::PU ls;  /* Synchronous reactance (&lt;i&gt;Ls&lt;/i&gt;).  Typical value = 3,2. Default: nullptr */
		CIMPP::Float pfrac;  /* Fraction of constant-power load to be represented by this motor model (&lt;i&gt;Pfrac&lt;/i&gt;) (&amp;gt;= 0,0 and &amp;lt;= 1,0).  Typical value = 0,3. Default: 0.0 */
		CIMPP::PU ra;  /* Stator resistance (&lt;i&gt;Ra&lt;/i&gt;).  Typical value = 0. Default: nullptr */
		CIMPP::Seconds tbkr;  /* Circuit breaker operating time (&lt;i&gt;Tbkr&lt;/i&gt;) (&amp;gt;= 0).  Typical value = 0,08. Default: nullptr */
		CIMPP::Seconds tpo;  /* Transient rotor time constant (&lt;i&gt;Tpo&lt;/i&gt;) (&amp;gt;= 0).  Typical value = 1. Default: nullptr */
		CIMPP::Seconds tppo;  /* Subtransient rotor time constant (&lt;i&gt;Tppo&lt;/i&gt;) (&amp;gt;= 0).  Typical value = 0,02. Default: nullptr */
		CIMPP::Seconds tv;  /* Voltage trip pickup time (&lt;i&gt;Tv&lt;/i&gt;) (&amp;gt;= 0).  Typical value = 0,1. Default: nullptr */
		CIMPP::PU vt;  /* Voltage threshold for tripping (&lt;i&gt;Vt&lt;/i&gt;).  Typical value = 0,7. Default: nullptr */
