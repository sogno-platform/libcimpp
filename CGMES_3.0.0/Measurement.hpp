...
namespace CIMPP
{
	...
	*/
	...
	public:
		...
		CIMPP::PowerSystemResource* PowerSystemResource;  /* The power system resource that contains the measurement. Default: 0 */
		CIMPP::ACDCTerminal* Terminal;  /* One or more measurements may be associated with a terminal in the network. Default: 0 */
		CIMPP::String measurementType;  /* Specifies the type of measurement.  For example, this specifies if the measurement represents an indoor temperature, outdoor temperature, bus voltage, line flow, etc. When the measurementType is set to `Specialization`, the type of Measurement is defined in more detail by the specialized class which inherits from Measurement. Default: '' */
