...
namespace CIMPP
{
	...
	*/
	class MeasurementValue : public IOPoint
	{
	public:
		...
		CIMPP::MeasurementValueSource* MeasurementValueSource;  /* A reference to the type of source that updates the MeasurementValue, e.g. SCADA, CCLink, manual, etc. User conventions for the names of sources are contained in the introduction to IEC 61970-301. Default: 0 */
