...
static const std::map<std::string, AttrDetails>& getClassAttrDetailsMap()
{
	...
	{
		{ "OperationalLimitType.OperationalLimit", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "OperationalLimitType.acceptableDuration", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "OperationalLimitType.direction", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
...
void OperationalLimitType::addPrimitiveAssignFnsToMap(std::unordered_map<std::string, assign_function>& assign_map)
{
	...
	assign_map.emplace("OperationalLimitType.isInfiniteDuration", &assign_OperationalLimitType_isInfiniteDuration);
	assign_map.emplace("OperationalLimitType.kind", &assign_OperationalLimitType_kind);
}
...
void OperationalLimitType::addPrimitiveGetFnsToMap(std::map<std::string, get_function>& get_map) const
{
	...
	get_map.emplace("OperationalLimitType.isInfiniteDuration", &get_OperationalLimitType_isInfiniteDuration);
}
...
void OperationalLimitType::addEnumGetFnsToMap(std::map<std::string, get_function>& get_map) const
{
	...
	get_map.emplace("OperationalLimitType.kind", &get_OperationalLimitType_kind);
}
