...
namespace CIMPP
{
	...
	/** \brief <font color="#0f0f0f">Power system stabilizer</font> function block whose dynamic behaviour is described by <font color="#0f0f0f">a user-defined model.</font> */
	class PowerSystemStabilizerUserDefined : public PowerSystemStabilizerDynamics
	{
	public:
		/* constructor initialising all attributes to null */
		PowerSystemStabilizerUserDefined();
		~PowerSystemStabilizerUserDefined() override;
