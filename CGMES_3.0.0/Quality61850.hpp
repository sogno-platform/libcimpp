...
namespace CIMPP
{
	...
	*/
	...
	public:
		...
		CIMPP::Boolean suspect;  /* A correlation function has detected that the value is not consistent with other values. Typically set by a network State Estimator. Default: false */
