...
void RegulatingControl::addPrimitiveAssignFnsToMap(std::unordered_map<std::string, assign_function>& assign_map)
{
	...
	assign_map.insert(std::make_pair(std::string("cim:RegulatingControl.maxAllowedTargetValue"), &assign_RegulatingControl_maxAllowedTargetValue));
	assign_map.insert(std::make_pair(std::string("cim:RegulatingControl.minAllowedTargetValue"), &assign_RegulatingControl_minAllowedTargetValue));
