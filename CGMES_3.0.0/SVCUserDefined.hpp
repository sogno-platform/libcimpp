#ifndef SVCUserDefined_H
#define SVCUserDefined_H
/*
...
namespace CIMPP
{
	...
	/** \brief Static var compensator (SVC) function block whose dynamic behaviour is described by <font color="#0f0f0f">a user-defined model.</font> */
	class SVCUserDefined : public StaticVarCompensatorDynamics
	{
	public:
		/* constructor initialising all attributes to null */
		SVCUserDefined();
		~SVCUserDefined() override;
