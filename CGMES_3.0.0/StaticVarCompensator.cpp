...
static const std::map<std::string, AttrDetails>& getClassAttrDetailsMap()
{
	...
	{
		{ "StaticVarCompensator.StaticVarCompensatorDynamics", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::DY, } } },
		{ "StaticVarCompensator.capacitiveRating", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "StaticVarCompensator.inductiveRating", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
		{ "StaticVarCompensator.q", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::SSH, } } },
		{ "StaticVarCompensator.sVCControlMode", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::EQ, } } },
...
{
	assign_map.emplace("StaticVarCompensator.StaticVarCompensatorDynamics", &assign_StaticVarCompensator_StaticVarCompensatorDynamics);
}
