...
static const std::map<std::string, std::list<CGMESProfile>> PossibleProfilesForAttributes =
{
	...
	{ "cim:SubGeographicalRegion.Lines", { CGMESProfile::EQ, CGMESProfile::EQBD, } },
	{ "cim:SubGeographicalRegion.Region", { CGMESProfile::EQ, CGMESProfile::EQBD, } },
	{ "cim:SubGeographicalRegion.Substations", { CGMESProfile::EQ, CGMESProfile::EQBD, } },
};
