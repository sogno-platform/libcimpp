...
namespace CIMPP
{
	...
	*/
	...
	public:
		...
		CIMPP::Float ks;  /* Saturation loading correction factor (&lt;i&gt;Ks&lt;/i&gt;) (&amp;gt;= 0).  Used only by type J model.  Typical value = 0. Default: 0.0 */
		...
		CIMPP::Seconds tc;  /* Damping time constant for `Canay` reactance (&amp;gt;= 0).  Typical value = 0. Default: nullptr */
		CIMPP::Seconds tpdo;  /* Direct-axis transient rotor time constant (&lt;i&gt;T`do&lt;/i&gt;) (&amp;gt; SynchronousMachineTimeConstantReactance.tppdo).  Typical value = 5. Default: nullptr */
		CIMPP::Seconds tppdo;  /* Direct-axis subtransient rotor time constant (&lt;i&gt;T``do&lt;/i&gt;) (&amp;gt; 0).  Typical value = 0,03. Default: nullptr */
		CIMPP::Seconds tppqo;  /* Quadrature-axis subtransient rotor time constant (&lt;i&gt;T``qo&lt;/i&gt;) (&amp;gt; 0). Typical value = 0,03. Default: nullptr */
		CIMPP::Seconds tpqo;  /* Quadrature-axis transient rotor time constant (&lt;i&gt;T`qo&lt;/i&gt;) (&amp;gt; SynchronousMachineTimeConstantReactance.tppqo). Typical value = 0,5. Default: nullptr */
		CIMPP::PU xDirectSubtrans;  /* Direct-axis subtransient reactance (unsaturated) (&lt;i&gt;X``d&lt;/i&gt;) (&amp;gt; RotatingMachineDynamics.statorLeakageReactance).  Typical value = 0,2. Default: nullptr */
		...
		CIMPP::PU xDirectTrans;  /* Direct-axis transient reactance (unsaturated) (&lt;i&gt;X`d&lt;/i&gt;) (&amp;gt;= SynchronousMachineTimeConstantReactance.xDirectSubtrans).  Typical value = 0,5. Default: nullptr */
		CIMPP::PU xQuadSubtrans;  /* Quadrature-axis subtransient reactance (&lt;i&gt;X``q&lt;/i&gt;) (&amp;gt; RotatingMachineDynamics.statorLeakageReactance).  Typical value = 0,2. Default: nullptr */
		CIMPP::PU xQuadSync;  /* Quadrature-axis synchronous reactance (&lt;i&gt;Xq&lt;/i&gt;) (&amp;gt;= SynchronousMachineTimeConstantReactance.xQuadTrans). The ratio of the component of reactive armature voltage, due to the quadrature-axis component of armature current, to this component of current, under steady state conditions and at rated frequency.  Typical value = 1,6. Default: nullptr */
		CIMPP::PU xQuadTrans;  /* Quadrature-axis transient reactance (&lt;i&gt;X`q&lt;/i&gt;) (&amp;gt;= SynchronousMachineTimeConstantReactance.xQuadSubtrans).  Typical value = 0,3. Default: nullptr */
