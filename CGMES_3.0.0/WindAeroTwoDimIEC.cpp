...
{
	factory_map.emplace("cim:WindAeroTwoDimIEC", &WindAeroTwoDimIEC_factory);
}

void WindAeroTwoDimIEC::addPrimitiveAssignFnsToMap(std::unordered_map<std::string, assign_function>& assign_map)
{
	assign_map.emplace("cim:WindAeroTwoDimIEC.dpomega", &assign_WindAeroTwoDimIEC_dpomega);
	assign_map.emplace("cim:WindAeroTwoDimIEC.dptheta", &assign_WindAeroTwoDimIEC_dptheta);
	assign_map.emplace("cim:WindAeroTwoDimIEC.dpv1", &assign_WindAeroTwoDimIEC_dpv1);
	assign_map.emplace("cim:WindAeroTwoDimIEC.omegazero", &assign_WindAeroTwoDimIEC_omegazero);
	assign_map.emplace("cim:WindAeroTwoDimIEC.pavail", &assign_WindAeroTwoDimIEC_pavail);
	assign_map.emplace("cim:WindAeroTwoDimIEC.thetav2", &assign_WindAeroTwoDimIEC_thetav2);
	assign_map.emplace("cim:WindAeroTwoDimIEC.thetazero", &assign_WindAeroTwoDimIEC_thetazero);
}

void WindAeroTwoDimIEC::addClassAssignFnsToMap(std::unordered_map<std::string, class_assign_function>& assign_map)
{
	assign_map.emplace("cim:WindAeroTwoDimIEC.WindTurbineType3IEC", &assign_WindAeroTwoDimIEC_WindTurbineType3IEC);
}
