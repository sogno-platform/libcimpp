...
{
	assign_map.emplace("cim:WindContPType4bIEC.dpmaxp4b", &assign_WindContPType4bIEC_dpmaxp4b);
	assign_map.emplace("cim:WindContPType4bIEC.tpaero", &assign_WindContPType4bIEC_tpaero);
	assign_map.emplace("cim:WindContPType4bIEC.tpordp4b", &assign_WindContPType4bIEC_tpordp4b);
	assign_map.emplace("cim:WindContPType4bIEC.tufiltp4b", &assign_WindContPType4bIEC_tufiltp4b);
}
