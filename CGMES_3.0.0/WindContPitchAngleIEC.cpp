...
{
	{ "cim:WindContPitchAngleIEC.WindTurbineType3IEC", { CGMESProfile::DY, } },
...
{
	assign_map.emplace("cim:WindContPitchAngleIEC.WindTurbineType3IEC", &assign_WindContPitchAngleIEC_WindTurbineType3IEC);
}
