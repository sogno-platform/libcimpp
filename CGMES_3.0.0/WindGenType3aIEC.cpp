...
{
	factory_map.emplace("cim:WindGenType3aIEC", &WindGenType3aIEC_factory);
}

void WindGenType3aIEC::addPrimitiveAssignFnsToMap(std::unordered_map<std::string, assign_function>& assign_map)
{
	assign_map.emplace("cim:WindGenType3aIEC.kpc", &assign_WindGenType3aIEC_kpc);
	assign_map.emplace("cim:WindGenType3aIEC.tic", &assign_WindGenType3aIEC_tic);
}

void WindGenType3aIEC::addClassAssignFnsToMap(std::unordered_map<std::string, class_assign_function>& assign_map)
{
	assign_map.emplace("cim:WindGenType3aIEC.WindTurbineType4IEC", &assign_WindGenType3aIEC_WindTurbineType4IEC);
}
