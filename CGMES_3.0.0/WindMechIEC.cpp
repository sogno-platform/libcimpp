...
static const std::map<std::string, AttrDetails>& getClassAttrDetailsMap()
{
	...
	{
		{ "WindMechIEC.WindTurbineType1or2IEC", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::DY, } } },
		{ "WindMechIEC.WindTurbineType3IEC", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::DY, } } },
		{ "WindMechIEC.WindTurbineType4bIEC", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::DY, } } },
		{ "WindMechIEC.cdrt", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::DY, } } },
		{ "WindMechIEC.hgen", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::DY, } } },
		{ "WindMechIEC.hwtr", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::DY, } } },
		{ "WindMechIEC.kdrt", { "http://iec.ch/TC57/CIM100#", { CGMESProfile::DY, } } },
	};
...
void WindMechIEC::addClassAssignFnsToMap(std::unordered_map<std::string, class_assign_function>& assign_map)
{
	...
	assign_map.emplace("WindMechIEC.WindTurbineType3IEC", &assign_WindMechIEC_WindTurbineType3IEC);
