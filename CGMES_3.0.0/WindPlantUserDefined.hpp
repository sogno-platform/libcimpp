...
namespace CIMPP
{
	...
	/** \brief Wind plant function block whose dynamic behaviour is described by <font color="#0f0f0f">a user-defined model.</font> */
	class WindPlantUserDefined : public WindPlantDynamics
	{
	public:
		/* constructor initialising all attributes to null */
		WindPlantUserDefined();
		~WindPlantUserDefined() override;
