...
namespace CIMPP
{
	...
	/** \brief Wind turbine IEC type 4A. Reference: IEC 61400-27-1:2015, 5.5.5.2. */
	...
	public:
		...
		/** \brief Wind generator type 4 model associated with this wind turbine type 4A model. Default: 0 */
